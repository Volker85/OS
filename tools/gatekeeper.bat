...
SET BASE_DIR=E:\NeuOrga\Programmieren\c_cpp\git_repro__os\input\tools
SET SRC_DIR=%BASE_DIR%\gatekeeper
SET OUTPUT_DIR=E:\NeuOrga\Programmieren\c_cpp\git_repro__os\output\gatekeeper\VERSION_X86
