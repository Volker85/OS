...
LFB11:
	...
	.loc 1 391 0
	movl	$_task_0.1355, -12(%ebp)
	.loc 1 392 0
	movl	$1, 28(%esp)
	movl	$200, 24(%esp)
	movl	$_TASK_STACK, 20(%esp)
	movl	$_TASK_GROUP_1.1359, 16(%esp)
	movl	$1, 12(%esp)
	movl	$1, 8(%esp)
	movl	$_TASK_0, 4(%esp)
	movl	-12(%ebp), %eax
	...
	call	_OS_INIT_TASK
	.loc 1 420 0
	movl	$_task_2.1357, -12(%ebp)
	.loc 1 421 0
	movl	$0, 28(%esp)
	movl	$200, 24(%esp)
	movl	$_TASK_STACK+400, 20(%esp)
	movl	$_TASK_GROUP_2.1360, 16(%esp)
	movl	$0, 12(%esp)
	movl	$1, 8(%esp)
	movl	$_TASK_2, 4(%esp)
	movl	-12(%ebp), %eax
	...
	call	_OS_INIT_TASK
	.loc 1 433 0
	movl	$_task_3.1358, -12(%ebp)
	.loc 1 434 0
	movl	$1, 28(%esp)
	movl	$200, 24(%esp)
	movl	$_TASK_STACK+600, 20(%esp)
	movl	$_TASK_GROUP_3.1361, 16(%esp)
	movl	$0, 12(%esp)
	movl	$1, 8(%esp)
	movl	$_TASK_3, 4(%esp)
	movl	-12(%ebp), %eax
...
L63:
	...
	movl	%eax, _link_list_member.1371
	.loc 1 475 0
	movl	_link_list_member.1371, %eax
	movl	%eax, (%esp)
...
L66:
	...
	movl	_task.1368, %eax
	movb	32(%eax), %dl
	movb	_Winner_prio.1369, %al
	cmpb	%al, %dl
	jbe	L65
	.loc 1 532 0
	movl	_task.1368, %eax
	movb	32(%eax), %al
	movb	%al, _Winner_prio.1369
	.loc 1 533 0
	movl	_task.1368, %eax
	movl	%eax, -12(%ebp)
L65:
...
LFB16:
	...
	.cfi_endproc
LFE16:
.lcomm _TASK_GROUP_1.1359,8,4
.lcomm _TASK_GROUP_2.1360,8,4
.lcomm _TASK_GROUP_3.1361,8,4
.lcomm _TASK_GROUP_4.1362,8,4
.lcomm _TASK_GROUP_5.1363,8,4
.lcomm _task_0.1355,96,32
.lcomm _task_1.1356,96,32
.lcomm _task_2.1357,96,32
.lcomm _task_3.1358,96,32
.lcomm _link_list_member.1371,4,4
.lcomm _task.1368,4,4
.lcomm _Winner_prio.1369,1,1
Letext0:
