...
LFB11:
	...
	.loc 1 391 0
	movl	$_task_0.1359, -12(%ebp)
	.loc 1 392 0
	movl	$1, 28(%esp)
	movl	$200, 24(%esp)
	movl	$_TASK_STACK, 20(%esp)
	movl	$_TASK_GROUP_1.1363, 16(%esp)
	movl	$1, 12(%esp)
	movl	$1, 8(%esp)
	movl	$_TASK_0, 4(%esp)
	movl	-12(%ebp), %eax
	...
	call	_OS_INIT_TASK
	.loc 1 420 0
	movl	$_task_2.1361, -12(%ebp)
	.loc 1 421 0
	movl	$0, 28(%esp)
	movl	$200, 24(%esp)
	movl	$_TASK_STACK+400, 20(%esp)
	movl	$_TASK_GROUP_2.1364, 16(%esp)
	movl	$0, 12(%esp)
	movl	$1, 8(%esp)
	movl	$_TASK_2, 4(%esp)
	movl	-12(%ebp), %eax
	...
	call	_OS_INIT_TASK
	.loc 1 433 0
	movl	$_task_3.1362, -12(%ebp)
	.loc 1 434 0
	movl	$1, 28(%esp)
	movl	$200, 24(%esp)
	movl	$_TASK_STACK+600, 20(%esp)
	movl	$_TASK_GROUP_3.1365, 16(%esp)
	movl	$0, 12(%esp)
	movl	$1, 8(%esp)
	movl	$_TASK_3, 4(%esp)
	movl	-12(%ebp), %eax
...
L65:
	...
	movl	%eax, _link_list_member.1375
	.loc 1 475 0
	movl	_link_list_member.1375, %eax
	movl	%eax, (%esp)
...
L68:
	...
	movl	_task.1372, %eax
	movb	36(%eax), %dl
	movb	_Winner_prio.1373, %al
	cmpb	%al, %dl
	jbe	L67
	.loc 1 532 0
	movl	_task.1372, %eax
	movb	36(%eax), %al
	movb	%al, _Winner_prio.1373
	.loc 1 533 0
	movl	_task.1372, %eax
	movl	%eax, -12(%ebp)
L67:
...
LFB13:
	...
	.cfi_endproc
LFE13:
.lcomm _TASK_GROUP_1.1363,8,4
.lcomm _TASK_GROUP_2.1364,8,4
.lcomm _TASK_GROUP_3.1365,8,4
.lcomm _TASK_GROUP_4.1366,8,4
.lcomm _TASK_GROUP_5.1367,8,4
.lcomm _task_0.1359,100,32
.lcomm _task_1.1360,100,32
.lcomm _task_2.1361,100,32
.lcomm _task_3.1362,100,32
.lcomm _link_list_member.1375,4,4
.lcomm _task.1372,4,4
.lcomm _Winner_prio.1373,1,1
Letext0:
...
Ldebug_macro0:
	...
	.byte	0x4
	.file 12 "E:/NeuOrga/Programmieren/c_cpp/github_os/input/src/os_base/../os_base/os_main.h"
	.byte	0x3
	.uleb128 0x7
	.uleb128 0xc
	.byte	0x1
	...
	.byte	0x4
	.byte	0x4
	.file 13 "E:/NeuOrga/Programmieren/c_cpp/github_os/input/src/os_base/../os_sim/lld_global.h"
	.byte	0x3
	.uleb128 0xa
	.uleb128 0xd
	.byte	0x1
	...
	.file 14 "E:/NeuOrga/Programmieren/c_cpp/github_os/input/src/os_base/../os_sim/lld_core.h"
	.byte	0x3
	.uleb128 0x4
	.uleb128 0xe
	.byte	0x1
