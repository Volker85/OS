...
LFB0:
	...
	subl	$24, %esp
	.loc 1 7 28
	movb	$0, _bTASK_QUEUE_INITIALIZED
	.loc 1 9 10
	movb	$0, -9(%ebp)
	.loc 1 9 4
	jmp	L2
L3:
	...
	movl	$0, _OS_SW_BUG(,%eax,4)
	.loc 1 9 26 discriminator 3
	movb	-9(%ebp), %al
	incl	%eax
	movb	%al, -9(%ebp)
L2:
	.loc 1 9 4 discriminator 1
	cmpb	$14, -9(%ebp)
	jbe	L3
	.loc 1 14 4
	...
	.loc 1 16 18
	movl	$0, _TASK2_CALL_NR
	.loc 1 17 18
	movl	$0, _TASK3_CALL_NR
	.loc 1 18 18
...
Ldebug_info0:
	...
	.byte	0x1
	.ascii "C:\\Users\\president\\Desktop\\sbx\\input\\src\\os_base\\os_start_init_sw.c\0"
