...
L5:
	...
	.loc 1 92 0
	movl	_sys_req_reset_state.1244, %eax
	testl	%eax, %eax
	je	L8
	cmpl	$1, %eax
	je	L9
...
L1:
	...
	.cfi_endproc
LFE0:
.lcomm _OS_STATE.1243,4,4
.lcomm _sys_req_reset_state.1244,4,4
Letext0:
...
Ldebug_info0:
	...
	.uleb128 0x5
	.byte	0x3
	.long	_sys_req_reset_state.1244
	.byte	0
	.byte	0
