...
L15:
	...
	.loc 1 138 0
	movl	_sys_req_reset_state.1409, %eax
	cmpl	$1, %eax
	je	L19
	cmpl	$1, %eax
	jb	L20
...
L16:
	...
	.cfi_endproc
LFE1:
.lcomm _call_nr.1398,4,4
.lcomm _call_nr.1410,4,4
.lcomm _sys_req_reset_state.1409,4,4
Letext0:
...
Ldebug_info0:
	...
	.uleb128 0x5
	.byte	0x3
	.long	_sys_req_reset_state.1409
	.uleb128 0x12
	.ascii "call_nr\0"
	.byte	0x1
	.byte	0x5c
