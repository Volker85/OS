...
L5:
	...
	.loc 1 91 0
	movl	_sys_req_reset_state.1277, %eax
	testl	%eax, %eax
	je	L8
	cmpl	$1, %eax
	je	L9
...
L1:
	...
	.cfi_endproc
LFE0:
.lcomm _OS_STATE.1276,4,4
.lcomm _sys_req_reset_state.1277,4,4
Letext0:
...
Ldebug_info0:
	...
	.uleb128 0x5
	.byte	0x3
	.long	_sys_req_reset_state.1277
	.byte	0
	.byte	0
