...
L17:
	...
	movl	$2, _OS_STATE
	.loc 1 130 0
	movl	$0, _sys_req_reset_state.1428
	.loc 1 132 0
	jmp	L16
L18:
	jmp	L16
L15:
	...
	.loc 1 137 0
	movl	_sys_req_reset_state.1428, %eax
	cmpl	$1, %eax
	je	L20
	cmpl	$1, %eax
	jb	L21
...
L16:
	...
	.cfi_endproc
LFE1:
.lcomm _call_nr.1417,4,4
.lcomm _call_nr.1429,4,4
	.data
	.align 4
_sys_req_reset_state.1428:
	.long	1
	.text
Letext0:
...
Ldebug_info0:
	...
	.uleb128 0x5
	.byte	0x3
	.long	_sys_req_reset_state.1428
	.uleb128 0x12
	.ascii "call_nr\0"
	.byte	0x1
	.byte	0x57
