...
LFB0:
	...
	movl	$-536810196, %eax
	movl	(%eax), %eax
	movl	%eax, _VAR_HARDFAULT_STATUS_REG
	.loc 1 17 0
	movl	$-536810200, %eax
	movl	(%eax), %eax
	movl	%eax, _VAR_FAULT_STATUS_REG
	.loc 1 18 0
	movl	$-536810188, %eax
	movl	(%eax), %eax
	movl	%eax, _VAR_MEM_FAULT_ADDR_REG
	.loc 1 19 0
	movl	$-536810184, %eax
	movl	(%eax), %eax
	movl	%eax, _VAR_BUS_FAULT_ADDR_REG
	.loc 1 20 0
	movl	$-536810180, %eax
	movl	(%eax), %eax
	movl	%eax, _VAR_AUX_FAULT_STATUS_REG
	.loc 1 21 0
	popl	%ebp
	.cfi_restore 5
	.cfi_def_cfa 4, 4
...
LFB1:
	...
	.cfi_def_cfa_register 5
	.loc 1 26 0
	call	_OS_Exception_Read_Status_Registers
L3:
...
LFE15:
Letext0:
	.file 2 "E:/NeuOrga/Programmieren/c_cpp/github_os/input/src/os_base/../os_base/os_ram.h"
...
Ldebug_macro0:
	...
	.byte	0x4
	.file 24 "E:/NeuOrga/Programmieren/c_cpp/github_os/input/src/os_base/os_ram.h"
	.byte	0x3
	.uleb128 0x5
	.uleb128 0x18
	.byte	0x4
