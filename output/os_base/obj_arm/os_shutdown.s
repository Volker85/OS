...
.LVL0:
	...
	.cfi_offset 3, -8
	.cfi_offset 14, -4
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:26: {
	.loc 1 26 0
	mov	r5, r1	@ addr, addr
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:31:    LLF_MPU_DISABLE();
	...
	bl	LLF_MPU_DISABLE	@
.LVL2:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:34:    if(reset_typ == E_OS_RESET_POWERDOWN)
	.loc 1 34 0
	cmp	r4, #1	@ reset_typ,
	beq	.L8	@,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:38:    else if(reset_typ == E_OS_RESET_HARDRESET) /* E_OS_RESET_HARDRESET */
	.loc 1 38 0
	cbz	r4, .L9	@ reset_typ,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:42:    else if (reset_typ == E_OS_RESET_EXIT)
	.loc 1 42 0
	cmp	r4, #2	@ reset_typ,
	beq	.L10	@,
.L3:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:53:    OS_SET_SW_BUG(E_OS_BUG_RESET_EXIT_OR_SHUTDOWN_FAILED, E_FUNC_SHUTDOWN);
	.loc 1 53 0
	movs	r1, #16	@,
	movs	r0, #8	@,
	bl	OS_SET_SW_BUG	@
...
.LBE9:
.LBE8:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:47:       OS_START_EXT_PRG((func_ptr_t)addr, (uint32)0u, (uint32)0u);
	.loc 1 47 0
	movs	r2, #0	@,
	mov	r0, r5	@, addr
	mov	r1, r2	@,
...
.Letext0:
	...
	.file 11 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_start_ext_prg.h"
