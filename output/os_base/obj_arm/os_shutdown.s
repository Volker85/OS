...
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_shutdown.c
@ -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -march=armv7e-m
@ -auxbase-strip C:\Users\president\Desktop\sbx\output\os_base\obj_arm\os_shutdown.s
...
.LVL0:
.LFB3:
	.file 1 "C:\\Users\\president\\Desktop\\sbx\\input\\src\\os_base\\os_shutdown.c"
	.loc 1 26 1 view -0
	.cfi_startproc
	@ Volatile: function does not return.
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 28 4 view .LVU1
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_shutdown.c:26: {
	...
	.cfi_offset 14, -4
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_shutdown.c:26: {
	.loc 1 26 1 view .LVU3
	mov	r5, r1	@ addr, addr
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_shutdown.c:28:    LLF_DISABLE_INTERRUPTS_ALL_CORES();
	.loc 1 28 4 view .LVU4
	bl	LLF_DISABLE_INTERRUPTS_ALL_CORES		@
.LVL1:
	.loc 1 31 4 is_stmt 1 view .LVU5
	bl	LLF_MPU_DISABLE		@
.LVL2:
	.loc 1 34 4 view .LVU6
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_shutdown.c:34:    if(reset_typ == E_OS_RESET_POWERDOWN)
	.loc 1 34 6 is_stmt 0 view .LVU7
	cmp	r4, #1	@ reset_typ,
	beq	.L8		@,
	.loc 1 38 9 is_stmt 1 view .LVU8
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_shutdown.c:38:    else if(reset_typ == E_OS_RESET_HARDRESET) /* E_OS_RESET_HARDRESET */
	.loc 1 38 11 is_stmt 0 view .LVU9
	cbz	r4, .L9	@ reset_typ,
	.loc 1 42 9 is_stmt 1 view .LVU10
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_shutdown.c:42:    else if (reset_typ == E_OS_RESET_EXIT)
	.loc 1 42 12 is_stmt 0 view .LVU11
	cmp	r4, #2	@ reset_typ,
	beq	.L10		@,
.L3:
	.loc 1 51 7 is_stmt 1 view .LVU12
	.loc 1 53 4 view .LVU13
	movs	r1, #16	@,
	movs	r0, #8	@,
	bl	OS_SET_SW_BUG		@
.LVL3:
.L5:
	.loc 1 54 4 discriminator 1 view .LVU14
	.loc 1 57 4 discriminator 1 view .LVU15
	.loc 1 54 4 discriminator 1 view .LVU16
	.loc 1 57 4 discriminator 1 view .LVU17
	b	.L5		@
.L8:
	.loc 1 36 7 view .LVU18
	bl	LLF_MCU_SWITCH_OFF_POWER		@
.LVL4:
	b	.L3		@
.L9:
	.loc 1 40 7 view .LVU19
	bl	LLF_MCU_RESET_POWER		@
.LVL5:
	b	.L3		@
.L10:
	.loc 1 44 7 view .LVU20
	.loc 1 12 1 view .LVU21
	.loc 1 45 7 view .LVU22
	.loc 1 17 1 view .LVU23
	.loc 1 46 7 view .LVU24
.LBB8:
.LBI8:
	.loc 1 18 6 view .LVU25
.LBB9:
	.loc 1 20 4 view .LVU26
	bl	LLF_MPU_DISABLE		@
.LVL6:
	.loc 1 21 4 view .LVU27
	bl	LLF_DISABLE_INTERRUPTS_ALL_CORES		@
.LVL7:
.LBE9:
.LBE8:
	.loc 1 47 7 view .LVU28
	movs	r2, #0	@,
	mov	r0, r5	@, addr
	mov	r1, r2	@,
	bl	OS_START_EXT_PRG		@
...
.Letext0:
	...
	.file 10 "c:\\users\\president\\desktop\\sbx\\input\\src\\os_drivers\\lld_global.h"
	.file 11 "C:\\Users\\president\\Desktop\\sbx\\input\\src\\os_base\\os_start_ext_prg.h"
