...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c
@ -mcpu=cortex-m4 -mthumb
@ -auxbase-strip E:\NeuOrga\Programmieren\c_cpp\github_os\output\os_base\obj_arm\os_shutdown.s
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:9: }
	.loc 1 9 0
	nop
	mov	sp, r7	@,
...
.LFB1:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:13: }
	.loc 1 13 0
	nop
	mov	sp, r7	@,
	.cfi_def_cfa_register 13
...
.LFB2:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:17: }
	.loc 1 17 0
	nop
	mov	sp, r7	@,
	.cfi_def_cfa_register 13
...
.LFB3:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
	mov	r3, r0	@ tmp110, reset_typ
	strb	r3, [r7, #7]	@ tmp111, reset_typ
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:22:    LLF_DISABLE_INTERRUPTS_ALL_CORES();
	.loc 1 22 0
	bl	LLF_DISABLE_INTERRUPTS_ALL_CORES	@
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:25:    LLF_MPU_DISABLE();
	.loc 1 25 0
	bl	LLF_MPU_DISABLE	@
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:30:    if(reset_typ == os_reset_powerdown)
	.loc 1 30 0
	ldrb	r3, [r7, #7]	@ zero_extendqisi2	@ tmp112, reset_typ
	cmp	r3, #1	@ tmp112,
	bne	.L5	@,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:32:       LLF_MCU_SWITCH_OFF_POWER();
	.loc 1 32 0
	bl	LLF_MCU_SWITCH_OFF_POWER	@
	b	.L6	@
.L5:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:34:    else if(reset_typ == os_reset_hardreset) /* os_reset_hardreset */
	.loc 1 34 0
	ldrb	r3, [r7, #7]	@ zero_extendqisi2	@ tmp113, reset_typ
	cmp	r3, #0	@ tmp113,
	bne	.L7	@,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:36:       LLF_MCU_RESET_POWER();
	.loc 1 36 0
	bl	LLF_MCU_RESET_POWER	@
	b	.L6	@
.L7:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:38:    else if (reset_typ == os_reset_exit)
	.loc 1 38 0
...
.L6:
.L8:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_shutdown.c:49:    while(1)
...
.Ldebug_macro0:
	...
	.4byte	.LASF504
	.byte	0x4
	.file 17 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_start_ext_prg.h"
	.byte	0x3
	.uleb128 0x3
	.uleb128 0x11
	.byte	0x5
