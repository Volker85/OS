...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c
@ -mcpu=cortex-m4 -mthumb
@ -auxbase-strip E:\NeuOrga\Programmieren\c_cpp\github_os\output\os_base\obj_arm\os_memory_mmu_setup.s
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:44:    *MPU_RNR  = 0;
	.loc 1 44 0
	ldr	r1, .L4	@ tmp110,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:45:    *MPU_RBAR = 0x08000000;/* FLASH Start */
	.loc 1 45 0
	ldr	r2, .L4+4	@ tmp112,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:46:    *MPU_RASR = MPU_ASR_NON_CACHABLE | MPU_ASR_ACCESS_PRIV_RO_UNPRIV_RO | MPU_ASR_REGION_SIZE_FLASH | MPU_ASR_REGION_ENABLE;
	.loc 1 46 0
	ldr	r3, .L4+8	@ tmp114,
	ldr	r0, .L4+12	@ tmp115,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:29: {
	.loc 1 29 0
	push	{r4, r5, r6, r7}	@
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:49:    *MPU_RNR  = 1;
	.loc 1 49 0
	movs	r0, #1	@ tmp117,
	str	r0, [r1]	@ tmp117, MEM[(volatile uint32 *)3758157208B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:51:    *MPU_RASR = MPU_ASR_NON_CACHABLE | MPU_ASR_ACCESS_PRIV_RW_UNPRIV_NOACCESS | MPU_ASR_REGION_SIZE_RAM | MPU_ASR_REGION_ENABLE;
	.loc 1 51 0
	ldr	r6, .L4+16	@ tmp121,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:56:    *MPU_RASR = MPU_ASR_STRONGLY_ORDERED | MPU_ASR_ACCESS_PRIV_RW_UNPRIV_NOACCESS | MPU_ASR_REGION_SIZE_PERIPHERIE | MPU_ASR_REGION_ENABLE;
	.loc 1 56 0
	ldr	r4, .L4+20	@ tmp127,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:64:    *MPU_RASR = MPU_ASR_NON_CACHABLE | MPU_ASR_ACCESS_PRIV_NOACCESS_UNPRIV_NOACCESS | MPU_ASR_REGION_SIZE_STACK_COOKIE | MPU_ASR_REGION_ENABLE;
	.loc 1 64 0
	ldr	r5, .L4+24	@ tmp139,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:50:    *MPU_RBAR = 0x20000000;/* RAM Start */
	.loc 1 50 0
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:54:    *MPU_RNR  = 2;
	.loc 1 54 0
	movs	r6, #2	@ tmp123,
	str	r6, [r1]	@ tmp123, MEM[(volatile uint32 *)3758157208B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:55:    *MPU_RBAR = 0x40000000;/* Peripherie Start */
	.loc 1 55 0
	mov	r6, #1073741824	@ tmp125,
	str	r6, [r2]	@ tmp125, MEM[(volatile uint32 *)3758157212B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:58:    *MPU_RNR  = 3;
	.loc 1 58 0
	movs	r6, #3	@ tmp129,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:56:    *MPU_RASR = MPU_ASR_STRONGLY_ORDERED | MPU_ASR_ACCESS_PRIV_RW_UNPRIV_NOACCESS | MPU_ASR_REGION_SIZE_PERIPHERIE | MPU_ASR_REGION_ENABLE;
	.loc 1 56 0
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:59:    *MPU_RBAR = 0xE0000000;/* Peripherie Start */
	.loc 1 59 0
	mov	r6, #-536870912	@ tmp131,
	str	r6, [r2]	@ tmp131, MEM[(volatile uint32 *)3758157212B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:62:    *MPU_RNR  = 4;
	.loc 1 62 0
	movs	r6, #4	@ tmp135,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:60:    *MPU_RASR = MPU_ASR_STRONGLY_ORDERED | MPU_ASR_ACCESS_PRIV_RW_UNPRIV_NOACCESS | MPU_ASR_REGION_SIZE_PERIPHERIE | MPU_ASR_REGION_ENABLE;
	.loc 1 60 0
	str	r4, [r3]	@ tmp127, MEM[(volatile uint32 *)3758157216B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:62:    *MPU_RNR  = 4;
	.loc 1 62 0
	str	r6, [r1]	@ tmp135, MEM[(volatile uint32 *)3758157208B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:63:    *MPU_RBAR = 0x20000000;/* Cookie Start */
	.loc 1 63 0
	str	r0, [r2]	@ tmp119, MEM[(volatile uint32 *)3758157212B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:64:    *MPU_RASR = MPU_ASR_NON_CACHABLE | MPU_ASR_ACCESS_PRIV_NOACCESS_UNPRIV_NOACCESS | MPU_ASR_REGION_SIZE_STACK_COOKIE | MPU_ASR_REGION_ENABLE;
	.loc 1 64 0
	str	r5, [r3]	@ tmp139, MEM[(volatile uint32 *)3758157216B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:71: }
	.loc 1 71 0
	pop	{r4, r5, r6, r7}	@
	.cfi_restore 7
	.cfi_restore 6
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu_setup.c:70:    LLF_MPU_ENABLE();
	.loc 1 70 0
	b	LLF_MPU_ENABLE	@
.LVL0:
.L5:
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 17 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_memory_mmu_setup.h"
	.byte	0x3
	.uleb128 0x2
	.uleb128 0x11
	.byte	0x5
