...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:20:    VAR_HARDFAULT_STATUS_REG = *HARDFAULT_STATUS_REG;
	...
	ldr	r3, [r3]	@ _2, *_1
	ldr	r2, .L2+4	@ tmp127,
	str	r3, [r2]	@ _2, VAR_HARDFAULT_STATUS_REG
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:21:    VAR_MEM_MANAG_FAULT_STATUS_REG     = *MEM_MANAG_FAULT_STATUS_REG;
	.loc 1 21 0
	ldr	r3, .L2+8	@ _3,
	ldrb	r3, [r3]	@ tmp128, *_3
	uxtb	r3, r3	@ _4, tmp128
	mov	r2, r3	@ _5, _4
	ldr	r3, .L2+12	@ tmp129,
	str	r2, [r3]	@ _5, VAR_MEM_MANAG_FAULT_STATUS_REG
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:22:    VAR_BUS_FAULT_STATUS_REG   = *BUS_FAULT_STATUS_REG;
	.loc 1 22 0
	ldr	r3, .L2+16	@ _6,
	ldrb	r3, [r3]	@ tmp130, *_6
	uxtb	r3, r3	@ _7, tmp130
	mov	r2, r3	@ _8, _7
	ldr	r3, .L2+20	@ tmp131,
	str	r2, [r3]	@ _8, VAR_BUS_FAULT_STATUS_REG
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:26:    VAR_AUX_FAULT_STATUS_REG = *AUX_FAULT_STATUS_REG;
	...
	ldr	r3, [r3]	@ _17, *_16
	ldr	r2, .L2+52	@ tmp136,
	str	r3, [r2]	@ _17, VAR_AUX_FAULT_STATUS_REG
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:27: }
	.loc 1 27 0
	nop
	mov	sp, r7	@,
...
.LFB1:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:33:    __asm__ __volatile__ ("LDR r0,%0;\
	.loc 1 33 0
	ldr	r3, .L6	@ tmp110,
	.syntax unified
...
@ 0 "" 2
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:39:    OS_Exception_Read_Status_Registers();
	.loc 1 39 0
	.thumb
	.syntax unified
	bl	OS_Exception_Read_Status_Registers	@
.L5:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:40:    while(1){}
...
.LFB2:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:49:    __asm__ __volatile__ ("LDR r0,%0;\
	.loc 1 49 0
	ldr	r3, .L10	@ tmp110,
	.syntax unified
@ 49 "E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c" 1
	LDR r0,[r3];                          STR r14,[r0];	@ LINK_REGISTER_HANDLER
@ 0 "" 2
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:55:    OS_Exception_Read_Status_Registers();
	.loc 1 55 0
	.thumb
	.syntax unified
	bl	OS_Exception_Read_Status_Registers	@
.L9:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:56:    while(1){}
...
.LFB3:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:63:    __asm__ __volatile__ ("LDR r0,%0;\
	.loc 1 63 0
	ldr	r3, .L13	@ tmp110,
	.syntax unified
@ 63 "E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c" 1
	LDR r0,[r3];                          STR r14,[r0];	@ LINK_REGISTER_HANDLER
@ 0 "" 2
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:71:    OS_ISRHANDLERC0();
	.loc 1 71 0
	.thumb
	.syntax unified
	bl	OS_ISRHANDLERC0	@
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:73: }
	.loc 1 73 0
	nop
	pop	{r7, pc}	@
.L14:
...
.LFB4:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:77:    __asm__ __volatile__ ("LDR r0,%0;\
	.loc 1 77 0
	ldr	r3, .L17	@ tmp110,
	.syntax unified
@ 77 "E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c" 1
	LDR r0,[r3];                          STR r14,[r0];	@ LINK_REGISTER_HANDLER
@ 0 "" 2
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:83:    OS_Exception_Read_Status_Registers();
	.loc 1 83 0
	.thumb
	.syntax unified
	bl	OS_Exception_Read_Status_Registers	@
.L16:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:84:    while(1){}
...
.LFB5:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:92:    OS_Exception_Read_Status_Registers();
	.loc 1 92 0
	bl	OS_Exception_Read_Status_Registers	@
.L20:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:93:    while(1){}
...
.LFB6:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:101:    __asm__ __volatile__ ("LDR r0,%0;\
	.loc 1 101 0
	ldr	r3, .L23	@ tmp110,
	.syntax unified
@ 101 "E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c" 1
	LDR r0,[r3];                          STR r14,[r0];	@ LINK_REGISTER_HANDLER
@ 0 "" 2
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:107:    OS_Exception_Read_Status_Registers();
	.loc 1 107 0
	.thumb
	.syntax unified
	bl	OS_Exception_Read_Status_Registers	@
.L22:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:108:    while(1){}
...
.LFB7:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:116:    __asm__ __volatile__ ("LDR r0,%0;\
	.loc 1 116 0
	ldr	r3, .L27	@ tmp110,
	.syntax unified
@ 116 "E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c" 1
	LDR r0,[r3];                          STR r14,[r0];	@ LINK_REGISTER_HANDLER
@ 0 "" 2
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:122:    OS_Exception_Read_Status_Registers();
	.loc 1 122 0
	.thumb
	.syntax unified
	bl	OS_Exception_Read_Status_Registers	@
.L26:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:123:    while(1){}
...
.LFB8:
	...
	.cfi_def_cfa_register 7
.L30:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:131:    while(1){}
...
.LFB9:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:141:    DBG_RLD_VALUE = 0xFFFFFFFF;
	.loc 1 141 0
	ldr	r3, .L33	@ tmp143,
	mov	r2, #-1	@ tmp144,
	str	r2, [r3]	@ tmp144, DBG_RLD_VALUE
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:142:    DBG_CURR_VAL = 0xFFFFFFFF;
	.loc 1 142 0
	ldr	r3, .L33+4	@ tmp145,
	mov	r2, #-1	@ tmp146,
	str	r2, [r3]	@ tmp146, DBG_CURR_VAL
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:143:    DBG_CTRL_VALUE = 0xFFFFFFFF;
	.loc 1 143 0
	ldr	r3, .L33+8	@ tmp147,
	mov	r2, #-1	@ tmp148,
	str	r2, [r3]	@ tmp148, DBG_CTRL_VALUE
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:144:    DBG_CALIB_VALUE = 0xFFFFFFFF;
	.loc 1 144 0
	ldr	r3, .L33+12	@ tmp149,
	mov	r2, #-1	@ tmp150,
	str	r2, [r3]	@ tmp150, DBG_CALIB_VALUE
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:147:    task = 0u;
	.loc 1 147 0
	movs	r3, #0	@ tmp151,
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:217:    if(task != 0u)
	...
	cmp	r3, #0	@ tmp157,
	beq	.L32	@,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:219:       OS_TASK_SAVETASK_ENVIRONMENT(task);
	.loc 1 219 0
	ldr	r0, [r7, #4]	@, task
	bl	OS_TASK_SAVETASK_ENVIRONMENT	@
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:220:       OS_TASK_RESTORE_SYSTEM_STACK(&OS_STACK[GET_CORE_ID()][0]);
	.loc 1 220 0
	bl	GET_CORE_ID	@
	mov	r3, r0	@ tmp158,
	lsls	r3, r3, #8	@ tmp159, _20,
	ldr	r2, .L33+32	@ tmp160,
	add	r3, r3, r2	@ _21, tmp160
	mov	r0, r3	@, _21
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:221:       task->active = False;
	.loc 1 221 0
	ldr	r2, [r7, #4]	@ tmp161, task
	ldrb	r3, [r2]	@ tmp162, task_47->active
	bfc	r3, #0, #1	@ tmp162,,
	strb	r3, [r2]	@ tmp162, task_47->active
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:222:       task->exe_time += (Get_current_time() - task->start_time);
	.loc 1 222 0
	bl	Get_current_time	@
	mov	r2, r0	@ _22,
	ldr	r3, [r7, #4]	@ tmp163, task
	ldr	r3, [r3, #32]	@ _23, task_47->start_time
	subs	r2, r2, r3	@ _53, _22, _23
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:223:       task->task_group->exe_time += (Get_current_time() - task->start_time);
	.loc 1 223 0
	bl	Get_current_time	@
	mov	r2, r0	@ _26,
	ldr	r3, [r7, #4]	@ tmp166, task
	ldr	r3, [r3, #32]	@ _27, task_47->start_time
	subs	r1, r2, r3	@ _56, _26, _27
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:224:       SET_RUNNING_TASK(0,0);
	...
	movs	r0, #0	@,
	bl	SET_RUNNING_TASK	@
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:225:       OS_TERMINATE_TASK(task,0);
	.loc 1 225 0
	movs	r1, #0	@,
	ldr	r0, [r7, #4]	@, task
	bl	OS_TERMINATE_TASK	@
.L32:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:227:    OS_STATE_HANDLER();
	.loc 1 227 0
	bl	OS_STATE_HANDLER	@
...
.LFB11:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:240:    OS_ISRHANDLERC0();
	.loc 1 240 0
	bl	OS_ISRHANDLERC0	@
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:242: }
	.loc 1 242 0
	nop
	pop	{r7, pc}	@
	.cfi_endproc
...
.LFB12:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:248:    OS_ISRHANDLERC0();
	.loc 1 248 0
	bl	OS_ISRHANDLERC0	@
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:250: }
	.loc 1 250 0
	nop
	pop	{r7, pc}	@
	.cfi_endproc
...
.LFB13:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:256: }
	.loc 1 256 0
	nop
	mov	sp, r7	@,
	.cfi_def_cfa_register 13
...
.LFB14:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:262: }
	.loc 1 262 0
	nop
	mov	sp, r7	@,
	.cfi_def_cfa_register 13
...
.LFB15:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception.c:268: }
	.loc 1 268 0
	nop
	mov	sp, r7	@,
	.cfi_def_cfa_register 13
