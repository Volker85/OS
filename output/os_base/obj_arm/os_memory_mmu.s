...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c
@ -mcpu=cortex-m4 -mthumb
@ -auxbase-strip E:\NeuOrga\Programmieren\c_cpp\github_os\output\os_base\obj_arm\os_memory_mmu.s
...
OS_MMU_SETUP:
.LFB0:
	.file 1 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_memory_mmu.c"
	.loc 1 11 0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:26:    *MPU_RNR  = 0u;
	.loc 1 26 0
	ldr	r1, .L4	@ tmp110,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:27:    *MPU_RBAR = 0x08000000u;/* FLASH Start */
	.loc 1 27 0
	ldr	r2, .L4+4	@ tmp112,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:28:    *MPU_RASR = MPU_ASR_NON_CACHABLE | MPU_ASR_ACCESS_PRIV_RO_UNPRIV_RO | MPU_ASR_REGION_SIZE_FLASH | MPU_ASR_REGION_ENABLE;
	.loc 1 28 0
	ldr	r3, .L4+8	@ tmp114,
	ldr	r0, .L4+12	@ tmp115,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:11: {
	.loc 1 11 0
	push	{r4, r5, r6, r7}	@
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:31:    *MPU_RNR  = 1u;
	.loc 1 31 0
	movs	r0, #1	@ tmp117,
	str	r0, [r1]	@ tmp117, MEM[(volatile uint32 *)3758157208B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:33:    *MPU_RASR = MPU_ASR_NON_CACHABLE | MPU_ASR_ACCESS_PRIV_RW_UNPRIV_NOACCESS | MPU_ASR_REGION_SIZE_RAM | MPU_ASR_REGION_ENABLE;
	.loc 1 33 0
	ldr	r6, .L4+16	@ tmp121,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:38:    *MPU_RASR = MPU_ASR_STRONGLY_ORDERED | MPU_ASR_ACCESS_PRIV_RW_UNPRIV_NOACCESS | MPU_ASR_REGION_SIZE_PERIPHERIE | MPU_ASR_REGION_ENABLE;
	.loc 1 38 0
	ldr	r4, .L4+20	@ tmp127,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:46:    *MPU_RASR = MPU_ASR_NON_CACHABLE | MPU_ASR_ACCESS_PRIV_NOACCESS_UNPRIV_NOACCESS | MPU_ASR_REGION_SIZE_STACK_COOKIE | MPU_ASR_REGION_ENABLE;
	.loc 1 46 0
	ldr	r5, .L4+24	@ tmp139,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:32:    *MPU_RBAR = 0x20000000u;/* RAM Start */
	.loc 1 32 0
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:36:    *MPU_RNR  = 2u;
	.loc 1 36 0
	movs	r6, #2	@ tmp123,
	str	r6, [r1]	@ tmp123, MEM[(volatile uint32 *)3758157208B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:37:    *MPU_RBAR = 0x40000000u;/* Peripherie Start */
	.loc 1 37 0
	mov	r6, #1073741824	@ tmp125,
	str	r6, [r2]	@ tmp125, MEM[(volatile uint32 *)3758157212B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:40:    *MPU_RNR  = 3u;
	.loc 1 40 0
	movs	r6, #3	@ tmp129,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:38:    *MPU_RASR = MPU_ASR_STRONGLY_ORDERED | MPU_ASR_ACCESS_PRIV_RW_UNPRIV_NOACCESS | MPU_ASR_REGION_SIZE_PERIPHERIE | MPU_ASR_REGION_ENABLE;
	.loc 1 38 0
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:41:    *MPU_RBAR = 0xE0000000u;/* Peripherie Start */
	.loc 1 41 0
	mov	r6, #-536870912	@ tmp131,
	str	r6, [r2]	@ tmp131, MEM[(volatile uint32 *)3758157212B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:44:    *MPU_RNR  = 4u;
	.loc 1 44 0
	movs	r6, #4	@ tmp135,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:42:    *MPU_RASR = MPU_ASR_STRONGLY_ORDERED | MPU_ASR_ACCESS_PRIV_RW_UNPRIV_NOACCESS | MPU_ASR_REGION_SIZE_PERIPHERIE | MPU_ASR_REGION_ENABLE;
	.loc 1 42 0
	str	r4, [r3]	@ tmp127, MEM[(volatile uint32 *)3758157216B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:44:    *MPU_RNR  = 4u;
	.loc 1 44 0
	str	r6, [r1]	@ tmp135, MEM[(volatile uint32 *)3758157208B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:45:    *MPU_RBAR = 0x20000000u;/* Cookie Start */
	.loc 1 45 0
	str	r0, [r2]	@ tmp119, MEM[(volatile uint32 *)3758157212B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:46:    *MPU_RASR = MPU_ASR_NON_CACHABLE | MPU_ASR_ACCESS_PRIV_NOACCESS_UNPRIV_NOACCESS | MPU_ASR_REGION_SIZE_STACK_COOKIE | MPU_ASR_REGION_ENABLE;
	.loc 1 46 0
	str	r5, [r3]	@ tmp139, MEM[(volatile uint32 *)3758157216B]
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:53: }
	.loc 1 53 0
	pop	{r4, r5, r6, r7}	@
	.cfi_restore 7
	.cfi_restore 6
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_memory_mmu.c:52:    LLF_MPU_ENABLE();
	.loc 1 52 0
	b	LLF_MPU_ENABLE	@
.LVL0:
.L5:
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 18 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_memory_mmu.h"
	.byte	0x3
	.uleb128 0x2
	.uleb128 0x12
	.byte	0x7
...
.LASF642:
	...
	.ascii	"\\src\\os_base\\os_memory_mmu.c\000"
.LASF258:
