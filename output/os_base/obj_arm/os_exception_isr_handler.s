...
.LVL0:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception_isr_handler.c:10:     switch(svc_number)
	.loc 1 10 0
	cbnz	r0, .L8	@ svc_number,
	bx	lr	@
.L8:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception_isr_handler.c:9: {    
	.loc 1 9 0
	push	{r3, lr}	@
	.cfi_def_cfa_offset 8
	.cfi_offset 3, -8
	.cfi_offset 14, -4
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception_isr_handler.c:20:        OS_SetSwBug(os_bug_svc_number_missing, Func_IsrHandler);
	.loc 1 20 0
	movs	r0, #10	@,
.LVL1:
	movs	r1, #18	@,
	bl	OS_SetSwBug	@
.LVL2:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception_isr_handler.c:21:        OS_Shutdown(os_reset_hardreset);
	.loc 1 21 0
	movs	r0, #0	@,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_exception_isr_handler.c:25: }
	.loc 1 25 0
	pop	{r3, lr}	@
	.cfi_restore 14
	.cfi_restore 3
