...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_scheduler.c:512:    OS_INIT_TASK(task_ptr,      /* task */
	.loc 1 512 0
	movs	r1, #2	@ tmp135,
	ldr	r9, .L229+56	@ tmp134,
	str	r1, [sp, #20]	@ tmp135,
	ldr	r1, .L229+24	@ tmp139,
	str	r1, [sp, #4]	@ tmp139,
	ldr	r1, .L229+28	@ tmp140,
	str	r1, [sp]	@ tmp140,
	mov	r3, r4	@, tmp113
	mov	r2, r6	@, tmp124
	mov	r0, r9	@, tmp134
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_scheduler.c:528:    OS_INIT_TASK(task_ptr,      /* task */
	.loc 1 528 0
	ldr	r8, .L229+60	@ tmp145,
	ldr	ip, .L229+64	@ tmp150,
	ldr	r1, .L229+36	@ tmp151,
	str	r7, [sp, #8]	@ tmp116,
	mov	lr, #3	@ tmp146,
