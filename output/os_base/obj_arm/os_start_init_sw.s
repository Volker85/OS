...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_init_sw.c:7:    bTASK_QUEUE_INITIALIZED = False;
	...
	ldr	r3, .L4	@ tmp112,
	movs	r2, #0	@ tmp113,
	strb	r2, [r3]	@ tmp114, bTASK_QUEUE_INITIALIZED
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_init_sw.c:9:    for(i = 0; i < 15; i++)
	.loc 1 9 0
	movs	r3, #0	@ tmp115,
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_init_sw.c:11:       OS_SW_BUG[i] = os_bug_no_bug;
	...
	ldr	r2, .L4+4	@ tmp117,
	movs	r1, #0	@ tmp118,
	strb	r1, [r2, r3]	@ tmp119, OS_SW_BUG
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_init_sw.c:9:    for(i = 0; i < 15; i++)
	.loc 1 9 0 discriminator 3
	ldrb	r3, [r7, #7]	@ zero_extendqisi2	@ i.0_2, i
	adds	r3, r3, #1	@ tmp120, i.0_2,
	strb	r3, [r7, #7]	@ tmp121, i
.L2:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_init_sw.c:9:    for(i = 0; i < 15; i++)
