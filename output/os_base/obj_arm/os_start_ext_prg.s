...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_ext_prg.c
@ -mcpu=cortex-m4 -mthumb
@ -auxbase-strip E:\NeuOrga\Programmieren\c_cpp\github_os\output\os_base\obj_arm\os_start_ext_prg.s
...
.Ltext0:
	...
	.thumb_func
	.fpu softvfp
	.type	os_signatur_valid, %function
os_signatur_valid:
.LFB0:
	.file 1 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_start_ext_prg.c"
	.loc 1 8 0
	.cfi_startproc
	...
	str	r0, [r7, #12]	@ LoadProgAddr, LoadProgAddr
	str	r1, [r7, #8]	@ PrgSignatur, PrgSignatur
	str	r2, [r7, #4]	@ PrgSize, PrgSize
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_ext_prg.c:17:    return True;
	.loc 1 17 0
	movs	r3, #1	@ _7,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_ext_prg.c:18: }
	.loc 1 18 0
	mov	r0, r3	@, <retval>
	adds	r7, r7, #20	@,,
	.cfi_def_cfa_offset 4
	...
	.cfi_endproc
.LFE0:
	.size	os_signatur_valid, .-os_signatur_valid
	.align	1
	.global	OS_StartExtPrg
	.syntax unified
	.thumb
	.thumb_func
	.fpu softvfp
	.type	OS_StartExtPrg, %function
OS_StartExtPrg:
.LFB1:
	.loc 1 20 0
	.cfi_startproc
	...
	str	r1, [r7, #8]	@ PrgSignatur, PrgSignatur
	str	r2, [r7, #4]	@ PrgSize, PrgSize
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_ext_prg.c:22:    if(os_signatur_valid(LoadProgAddr, PrgSignatur, PrgSize) == False)
	.loc 1 22 0
	ldr	r2, [r7, #4]	@, PrgSize
	ldr	r1, [r7, #8]	@, PrgSignatur
	ldr	r0, [r7, #12]	@, LoadProgAddr
	bl	os_signatur_valid	@
	mov	r3, r0	@ tmp111,
	cmp	r3, #0	@ _1,
	beq	.L6	@,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_ext_prg.c:28:    LLF_MPU_DISABLE();
	.loc 1 28 0
	bl	LLF_MPU_DISABLE	@
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_ext_prg.c:30:    LLF_MPU_SWITCH_OFF_ALL_REGIONS();
	.loc 1 30 0
	bl	LLF_MPU_SWITCH_OFF_ALL_REGIONS	@
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_ext_prg.c:39:    LoadProgAddr();
	.loc 1 39 0
	ldr	r3, [r7, #12]	@ tmp112, LoadProgAddr
	blx	r3	@ tmp112
.LVL0:
	b	.L3	@
.L6:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_ext_prg.c:24:       return;
	.loc 1 24 0
	nop
.L3:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_ext_prg.c:40: }
	.loc 1 40 0
	adds	r7, r7, #16	@,,
	.cfi_def_cfa_offset 8
	mov	sp, r7	@,
	...
	.cfi_endproc
.LFE1:
	.size	OS_StartExtPrg, .-OS_StartExtPrg
.Letext0:
