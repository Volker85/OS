...
.LFB0:
	...
	mov	r3, r0	@ tmp111, bug_nr
	mov	r2, r1	@ tmp113, task_func_nr
	strb	r3, [r7, #7]	@ tmp112, bug_nr
	mov	r3, r2	@ tmp114, tmp113
	strb	r3, [r7, #6]	@ tmp114, task_func_nr
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_common.c:6:    OS_SW_BUG[task_func_nr] = bug_nr;
	.loc 1 6 0
	ldrb	r3, [r7, #6]	@ zero_extendqisi2	@ _1, task_func_nr
	ldr	r1, .L2	@ tmp115,
	ldrb	r2, [r7, #7]	@ tmp116, bug_nr
	strb	r2, [r1, r3]	@ tmp116, OS_SW_BUG
...
.LFB1:
	...
	add	r7, sp, #0	@,,
	.cfi_def_cfa_register 7
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_common.c:10:    return (0);
	.loc 1 10 0
	movs	r3, #0	@ _1,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_common.c:11: }
	.loc 1 11 0
	mov	r0, r3	@, <retval>
	mov	sp, r7	@,
	.cfi_def_cfa_register 13
