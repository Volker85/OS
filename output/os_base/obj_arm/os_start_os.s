...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_os.c:12:    VAR_HARDFAULT_STATUS_REG       = 0u;
	.loc 1 12 0
	ldr	r3, .L2	@ tmp114,
	movs	r2, #0	@ tmp115,
	str	r2, [r3]	@ tmp115, VAR_HARDFAULT_STATUS_REG
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_os.c:13:    VAR_MEM_MANAG_FAULT_STATUS_REG = 0u;
	.loc 1 13 0
	ldr	r3, .L2+4	@ tmp116,
	movs	r2, #0	@ tmp117,
	str	r2, [r3]	@ tmp117, VAR_MEM_MANAG_FAULT_STATUS_REG
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_os.c:14:    VAR_USAGE_FAULT_STATUS_REG     = 0u;
	.loc 1 14 0
	ldr	r3, .L2+8	@ tmp118,
	movs	r2, #0	@ tmp119,
	str	r2, [r3]	@ tmp119, VAR_USAGE_FAULT_STATUS_REG
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_os.c:15:    VAR_FAULT_STATUS_REG           = 0u;
	.loc 1 15 0
	ldr	r3, .L2+12	@ tmp120,
	movs	r2, #0	@ tmp121,
	str	r2, [r3]	@ tmp121, VAR_FAULT_STATUS_REG
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_os.c:16:    VAR_MEM_FAULT_ADDR_REG         = 0u;
	.loc 1 16 0
	ldr	r3, .L2+16	@ tmp122,
	movs	r2, #0	@ tmp123,
	str	r2, [r3]	@ tmp123, VAR_MEM_FAULT_ADDR_REG
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_os.c:17:    VAR_BUS_FAULT_ADDR_REG         = 0u;
	.loc 1 17 0
	ldr	r3, .L2+20	@ tmp124,
	movs	r2, #0	@ tmp125,
	str	r2, [r3]	@ tmp125, VAR_BUS_FAULT_ADDR_REG
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_os.c:18:    VAR_AUX_FAULT_STATUS_REG       = 0u;
	.loc 1 18 0
	ldr	r3, .L2+24	@ tmp126,
	movs	r2, #0	@ tmp127,
	str	r2, [r3]	@ tmp127, VAR_AUX_FAULT_STATUS_REG
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_os.c:19:    VAR_BUS_FAULT_STATUS_REG       = 0u;
	.loc 1 19 0
	ldr	r3, .L2+28	@ tmp128,
	movs	r2, #0	@ tmp129,
	str	r2, [r3]	@ tmp129, VAR_BUS_FAULT_STATUS_REG
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_os.c:20:    LINK_REGISTER_HANDLER          = 0u;
	.loc 1 20 0
	ldr	r3, .L2+32	@ tmp130,
	movs	r2, #0	@ tmp131,
	str	r2, [r3]	@ tmp131, LINK_REGISTER_HANDLER
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_os.c:21:    BACKUP_SYSTICK_CURRENT_VAL_REG = 0u;
	.loc 1 21 0
	ldr	r3, .L2+36	@ tmp132,
	movs	r2, #0	@ tmp133,
	str	r2, [r3]	@ tmp133, BACKUP_SYSTICK_CURRENT_VAL_REG
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_os.c:24:    SYS_HANDLER_CTRL_STATE_ENA_ALL_EXCEP;
	.loc 1 24 0
	ldr	r3, .L2+40	@ _1,
	ldr	r3, [r3]	@ _2, *_1
	ldr	r2, .L2+40	@ _3,
	orr	r3, r3, #458752	@ _4, _2,
	str	r3, [r2]	@ _4, *_3
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_start_os.c:27:    OS_STATE = os_init;
	.loc 1 27 0
	ldr	r3, .L2+44	@ tmp134,
	movs	r2, #0	@ tmp135,
