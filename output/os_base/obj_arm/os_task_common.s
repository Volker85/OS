...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:34:    return;
	...
	b	.L1	@
.L2:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:32:       OS_SET_SW_BUG(os_bug_null_pointer,Func_SaveTaskEnvironment);
	.loc 1 32 0
	movs	r1, #1	@,
	movs	r0, #2	@,
	bl	OS_SET_SW_BUG	@
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:48: }
	...
	b	.L8	@
.L6:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:46:       OS_SET_SW_BUG(os_bug_null_pointer,Func_RestoreTaskEnvironment);
	.loc 1 46 0
	movs	r1, #2	@,
	movs	r0, #2	@,
	bl	OS_SET_SW_BUG	@
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:108: }
	...
	b	.L14	@
.L12:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:106:       OS_SET_SW_BUG(os_bug_null_pointer,Func_CreateTaskEnvironment);
	.loc 1 106 0
	movs	r1, #3	@,
	movs	r0, #2	@,
	bl	OS_SET_SW_BUG	@
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:114:       os_free(task->pStackPointerByMalloc);/* only possible in case of heap used */
	...
	b	.L19	@
.L18:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:118:       OS_SET_SW_BUG(os_bug_null_pointer,Func_DeleteTaskEnvironment);
	.loc 1 118 0
	movs	r1, #4	@,
	movs	r0, #2	@,
	bl	OS_SET_SW_BUG	@
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:126:    if(task == 0)
	...
	cmp	r3, #0	@ tmp113,
	bne	.L21	@,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:128:       OS_SET_SW_BUG(os_bug_null_pointer,Func_CreateTaskEnvironment);
	.loc 1 128 0
	movs	r1, #3	@,
	movs	r0, #2	@,
	bl	OS_SET_SW_BUG	@
