...
.LVL0:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:17:    if(task != 0u)
	.loc 1 17 0
	cbz	r0, .L2	@ task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:16: {
	...
	.cfi_offset 14, -4
	mov	r4, r0	@ task, task
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:23:       LLF_SAVE_TASK_STACK(task->p_stack_pointer);
	.loc 1 23 0
...
.LVL4:
.L2:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:32:       OS_SET_SW_BUG(E_OS_BUG_NULL_POINTER,E_FUNC_SAVETASKENVIRONMENT);
	.loc 1 32 0
	movs	r1, #1	@,
	movs	r0, #2	@,
.LVL5:
...
.LFB1:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
.LVL7:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:39:    if(task!=0u)
	.loc 1 39 0
	cbz	r0, .L8	@ task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:38: {
	...
	.cfi_offset 14, -4
	mov	r4, r0	@ task, task
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:41:       LLF_RESTORE_TASK_STACK(task->p_stack_pointer);
	.loc 1 41 0
...
.LVL11:
.L8:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:46:       OS_SET_SW_BUG(E_OS_BUG_NULL_POINTER,E_FUNC_RESTORETASKENVIRONMENT);
	.loc 1 46 0
	movs	r1, #2	@,
	mov	r0, r1	@,
.LVL12:
...
.LFB4:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
.LVL18:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:59:    if(task != 0u)
	.loc 1 59 0
	cmp	r0, #0	@ task
	beq	.L15	@
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:70:       task->r0                             = (unsigned_int32_t)       0u;
	.loc 1 70 0
	movs	r5, #0	@ tmp118,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:62:       task->active                = FALSE;
	.loc 1 62 0
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:82:       task->r12                             = (unsigned_int32_t)       0u;
	.loc 1 82 0
	str	r5, [r0, #180]	@ tmp118, task_7(D)->r12
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:71:       task->r1                             = (unsigned_int32_t)       0u;
	.loc 1 71 0
	strd	r5, r5, [r0, #132]	@ tmp118, tmp118, task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:73:       task->r3                             = (unsigned_int32_t)       0u;
	.loc 1 73 0
	strd	r5, r5, [r0, #140]	@ tmp118, tmp118, task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:75:       task->r5                             = (unsigned_int32_t)       0u;
	.loc 1 75 0
	strd	r5, r5, [r0, #148]	@ tmp118, tmp118, task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:77:       task->r7                             = (unsigned_int32_t)       0u;
	.loc 1 77 0
	strd	r5, r5, [r0, #156]	@ tmp118, tmp118, task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:79:       task->r9                             = (unsigned_int32_t)       0u;
	.loc 1 79 0
	strd	r5, r5, [r0, #164]	@ tmp118, tmp118, task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:81:       task->r11                             = (unsigned_int32_t)       0u;
	.loc 1 81 0
	strd	r5, r5, [r0, #172]	@ tmp118, tmp118, task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:85:       ASSIGN_NULL(&task->wait_act_until);
	.loc 1 85 0
	adds	r0, r0, #6	@, task,
.LVL19:
	bl	ASSIGN_NULL	@
.LVL20:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:86:       ASSIGN_NULL(&task->wait_time);
	.loc 1 86 0
	add	r0, r4, #22	@, task,
	bl	ASSIGN_NULL	@
.LVL21:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:87:       ASSIGN_UINT32(&task->time_to_prio_inc, 5u);
	.loc 1 87 0
	movs	r1, #5	@,
	add	r0, r4, #38	@, task,
	bl	ASSIGN_UINT32	@
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:89:       ASSIGN_UINT32(&task->max_allowed_wait_time,         100000u);
	.loc 1 89 0
	ldr	r1, .L21	@,
	add	r0, r4, #60	@, task,
	bl	ASSIGN_UINT32	@
.LVL23:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:90:       ASSIGN_NULL(&task->exe_time);
	.loc 1 90 0
	add	r0, r4, #76	@, task,
	bl	ASSIGN_NULL	@
.LVL24:
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:95:       task->state_request                    =                           &OS_TASK_STATE_REQUEST;
	.loc 1 95 0
	ldr	r2, .L21+4	@ tmp140,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:91:       task->current_prio                     = (unsigned_char_t)         0u;
	.loc 1 91 0
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:98:       task->free                             =                           0u;
	.loc 1 98 0
	ldr	r3, [r4]	@ task_7(D)->free, task_7(D)->free
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:99:       task->nr_of_ins_allowed                   = (unsigned_char_t)         0u;
	.loc 1 99 0
	strb	r5, [r4, #4]	@ tmp118, task_7(D)->nr_of_ins_allowed
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:98:       task->free                             =                           0u;
	.loc 1 98 0
	bfi	r3, r5, #3, #29	@ task_7(D)->free, tmp118,,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:100:       task->nr_of_ins_activated                 = (unsigned_char_t)         0u;
	.loc 1 100 0
	strb	r5, [r4, #5]	@ tmp118, task_7(D)->nr_of_ins_activated
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:96:       task->task_state                       =                           E_TASK_UNSPECIFIED;
	.loc 1 96 0
	strb	r5, [r4, #124]	@ tmp118, task_7(D)->task_state
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:101:       task->fp                               = (func_p_t)                0u;
	.loc 1 101 0
...
.L15:
	...
	.cfi_restore 5
	.cfi_restore 14
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:106:       OS_SET_SW_BUG(E_OS_BUG_NULL_POINTER,E_FUNC_INITTASKENVIRONMENT);
	.loc 1 106 0
	movs	r1, #5	@,
	movs	r0, #2	@,
.LVL26:
...
.Ldebug_macro0:
	...
	.uleb128 0x12
	.byte	0x4
	.file 19 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_task_scheduler.h"
	.byte	0x3
	.uleb128 0x3
	.uleb128 0x13
	.byte	0x7
	.4byte	.Ldebug_macro6
	.byte	0x4
	.file 20 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_heap.h"
	.byte	0x3
	.uleb128 0x4
	.uleb128 0x14
	.byte	0x4
