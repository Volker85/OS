...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:17:    if(task != 0)
	.loc 1 17 0
	cbz	r0, .L2	@ task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:16: {
	.loc 1 16 0
	push	{r4, lr}	@
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:23:       LLF_SAVE_TASK_STACK(task->pStackPointer);
	.loc 1 23 0
	ldr	r0, [r0, #184]	@, task_7(D)->pStackPointer
.LVL1:
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:39:    if(task!=0)
	.loc 1 39 0
	cbz	r0, .L8	@ task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:38: {
	.loc 1 38 0
	push	{r4, lr}	@
	.cfi_def_cfa_offset 8
	.cfi_offset 4, -8
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:41:       LLF_RESTORE_TASK_STACK(task->pStackPointer);
	.loc 1 41 0
	ldr	r0, [r0, #184]	@, task_3(D)->pStackPointer
.LVL8:
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:59:    if(task != 0)
	...
	cmp	r0, #0	@ task
	beq	.L15	@
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:58: {
	.loc 1 58 0
	push	{r3, r4, r5, lr}	@
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:82:       task->r12                             = (unsigned_int32_t)       0;
	.loc 1 82 0
	str	r5, [r0, #180]	@ tmp118, task_7(D)->r12
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:71:       task->r1                             = (unsigned_int32_t)       0;
	.loc 1 71 0
	strd	r5, r5, [r0, #132]	@ tmp118, tmp118, task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:73:       task->r3                             = (unsigned_int32_t)       0;
	.loc 1 73 0
	strd	r5, r5, [r0, #140]	@ tmp118, tmp118, task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:75:       task->r5                             = (unsigned_int32_t)       0;
	.loc 1 75 0
	strd	r5, r5, [r0, #148]	@ tmp118, tmp118, task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:77:       task->r7                             = (unsigned_int32_t)       0;
	.loc 1 77 0
	strd	r5, r5, [r0, #156]	@ tmp118, tmp118, task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:79:       task->r9                             = (unsigned_int32_t)       0;
	.loc 1 79 0
	strd	r5, r5, [r0, #164]	@ tmp118, tmp118, task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:81:       task->r11                             = (unsigned_int32_t)       0;
	.loc 1 81 0
	strd	r5, r5, [r0, #172]	@ tmp118, tmp118, task,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:85:       AssignNull(&task->WaitActUntil);
	.loc 1 85 0
	adds	r0, r0, #6	@, task,
.LVL19:
	bl	AssignNull	@
.LVL20:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:86:       AssignNull(&task->wait_time);
	.loc 1 86 0
	add	r0, r4, #22	@, task,
	bl	AssignNull	@
.LVL21:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:87:       AssignUint32(&task->TimeToPrioInc, 5u);
	.loc 1 87 0
	movs	r1, #5	@,
	add	r0, r4, #38	@, task,
	bl	AssignUint32	@
.LVL22:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:88:       task->overwaittime_per_prio_inc_step   = (unsigned_int32_t)        1u;/* has to be >=1 */
	.loc 1 88 0
	movs	r3, #1	@ tmp134,
	str	r3, [r4, #56]	@ tmp134, task_7(D)->overwaittime_per_prio_inc_step
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:89:       AssignUint32(&task->max_allowed_wait_time,         100000u);
	.loc 1 89 0
	ldr	r1, .L21	@,
	add	r0, r4, #60	@, task,
	bl	AssignUint32	@
.LVL23:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:90:       AssignNull(&task->exe_time);
	.loc 1 90 0
	add	r0, r4, #76	@, task,
	bl	AssignNull	@
.LVL24:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_task_common.c:97:       task->task_queued                      =                           False;
	.loc 1 97 0
	ldrb	r3, [r4]	@ zero_extendqisi2	@, task_7(D)->task_queued
