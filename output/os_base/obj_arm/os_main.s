...
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c
@ -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -march=armv7e-m
@ -auxbase-strip C:\Users\president\Desktop\sbx\output\os_base\obj_arm\os_main.s
...
OS_STATE_HANDLER:
.LFB1:
	.file 1 "C:\\Users\\president\\Desktop\\sbx\\input\\src\\os_base\\os_main.c"
	.loc 1 84 1 view -0
	.cfi_startproc
	...
	.loc 1 89 4 view .LVU3
	ldr	r5, .L27	@ tmp189,
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:84: {
	.loc 1 84 1 is_stmt 0 view .LVU4
	push	{r3, lr}	@
	.cfi_def_cfa_offset 8
	.cfi_offset 3, -8
	.cfi_offset 14, -4
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:89:    switch(OS_STATE)
	.loc 1 89 4 view .LVU5
	ldrb	r3, [r5]	@ zero_extendqisi2	@ OS_STATE, OS_STATE
	uxtb	r3, r3	@ OS_STATE.0_1, OS_STATE
	cmp	r3, #1	@ OS_STATE.0_1,
	beq	.L2		@,
	sxtb	r4, r3	@ OS_STATE.0_1, OS_STATE.0_1
	cbz	r4, .L3	@ OS_STATE.0_1,
	cmp	r3, #2	@ OS_STATE.0_1,
	bne	.L5		@,
	.loc 1 135 7 is_stmt 1 view .LVU6
	bl	LLF_INT_DISABLE		@
.LVL0:
	.loc 1 136 7 view .LVU7
	ldr	r3, .L27+4	@ tmp186,
	ldrb	r0, [r3]	@ zero_extendqisi2	@ sys_req_reset_state.4_8, sys_req_reset_state
	cmp	r0, #1	@ sys_req_reset_state.4_8,
	beq	.L17		@,
	sxtb	r1, r0	@ sys_req_reset_state.4_8, sys_req_reset_state.4_8
	cmp	r1, #0	@ sys_req_reset_state.4_8
	beq	.L16	@
	cmp	r0, #2	@ sys_req_reset_state.4_8,
	beq	.L17		@,
	.loc 1 155 10 view .LVU8
	movs	r1, #0	@,
	mov	r0, r1	@,
	bl	OS_SHUTDOWN		@
.LVL1:
	.loc 1 156 10 view .LVU9
	movs	r1, #19	@,
	movs	r0, #8	@,
	bl	OS_SET_SW_BUG		@
.LVL2:
	.loc 1 157 10 view .LVU10
.L5:
	.loc 1 168 4 view .LVU11
	bl	OS_STACK_CHECK		@
.LVL3:
.L19:
	.loc 1 171 4 discriminator 1 view .LVU12
	.loc 1 173 4 discriminator 1 view .LVU13
	.loc 1 171 4 discriminator 1 view .LVU14
	.loc 1 173 4 discriminator 1 view .LVU15
	b	.L19		@
.L2:
	.loc 1 119 7 view .LVU16
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:119:       if(call_nr % 5u == 0u)
	.loc 1 119 18 is_stmt 0 view .LVU17
	ldr	r4, .L27+8	@ tmp188,
	ldr	r2, [r4]	@ call_nr, call_nr
	movs	r3, #5	@ tmp142,
	udiv	r3, r2, r3	@ tmp141, call_nr, tmp142
	add	r3, r3, r3, lsl #2	@ tmp145, tmp141, tmp141,
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:119:       if(call_nr % 5u == 0u)
	.loc 1 119 9 view .LVU18
	cmp	r2, r3	@ call_nr, tmp145
	beq	.L26		@,
.L7:
	.loc 1 123 7 is_stmt 1 view .LVU19
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:123:       call_nr++;
	.loc 1 123 14 is_stmt 0 view .LVU20
	ldr	r3, [r4]	@ call_nr, call_nr
	adds	r3, r3, #1	@ tmp175, call_nr,
	str	r3, [r4]	@ tmp175, call_nr
	.loc 1 125 7 is_stmt 1 view .LVU21
	bl	OS_TASK_DISPATCHER		@
.LVL4:
	.loc 1 126 7 view .LVU22
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:126:       if(SYSTEM_STATE_ACCEPTED == OS_STATE_SHUTDOWN) /* check for shutdown/reset/exit conditions: currently shutdown is not planned to be supported... */
	.loc 1 126 32 is_stmt 0 view .LVU23
	ldr	r3, .L27+12	@ tmp177,
...
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:126:       if(SYSTEM_STATE_ACCEPTED == OS_STATE_SHUTDOWN) /* check for shutdown/reset/exit conditions: currently shutdown is not planned to be supported... */
	.loc 1 126 9 view .LVU24
	cmp	r3, #2	@ SYSTEM_STATE_ACCEPTED.3_7,
	bne	.L5		@,
	.loc 1 128 10 is_stmt 1 view .LVU25
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:129:          sys_req_reset_state = E_OS_RESET_HARDRESET;
	.loc 1 129 30 is_stmt 0 view .LVU26
	ldr	r2, .L27+4	@ tmp183,
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:128:          OS_STATE = OS_STATE_SHUTDOWN;
	.loc 1 128 19 view .LVU27
	strb	r3, [r5]	@ SYSTEM_STATE_ACCEPTED.3_7, OS_STATE
	.loc 1 129 10 is_stmt 1 view .LVU28
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:129:          sys_req_reset_state = E_OS_RESET_HARDRESET;
	.loc 1 129 30 is_stmt 0 view .LVU29
	movs	r3, #0	@ tmp184,
	strb	r3, [r2]	@ tmp184, sys_req_reset_state
	b	.L5		@
.L3:
	.loc 1 94 7 is_stmt 1 view .LVU30
	bl	OS_INIT_MC		@
.LVL5:
...
.LVL8:
	...
	bl	GET_IDLE_TASK		@
.LVL9:
	mov	r1, r4	@, OS_STATE.0_1
	bl	OS_START_TASK		@
.LVL10:
	.loc 1 105 7 view .LVU35
	bl	OS_ACTIVATE_DISPATCHER		@
.LVL11:
	.loc 1 107 7 view .LVU36
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:107:       OS_STATE = OS_STATE_RUNNING;
	.loc 1 107 16 is_stmt 0 view .LVU37
	movs	r3, #1	@ tmp134,
	strb	r3, [r5]	@ tmp134, OS_STATE
	.loc 1 109 7 is_stmt 1 view .LVU38
	bl	LLF_INT_ENABLE		@
.LVL12:
	.loc 1 110 7 view .LVU39
	b	.L5		@
.L26:
	.loc 1 121 10 view .LVU40
.LBB4:
.LBI4:
	.loc 1 50 12 view .LVU41
.LBB5:
	.loc 1 52 4 view .LVU42
	.loc 1 53 4 view .LVU43
...
.LBE5:
.LBE4:
	.loc 1 145 10 view .LVU44
	mov	r0, r1	@,
	bl	OS_SHUTDOWN		@
.LVL13:
	.loc 1 146 10 view .LVU45
	b	.L5		@
.L17:
	.loc 1 150 10 view .LVU46
	movs	r1, #0	@,
	bl	OS_SHUTDOWN		@
.LVL14:
	.loc 1 151 10 view .LVU47
	b	.L5		@
.L13:
.LBB7:
.LBB6:
	.loc 1 56 7 view .LVU48
	ldr	r0, .L27+20	@,
	bl	OS_ACTIVATE_TASK		@
.LVL15:
	.loc 1 57 7 view .LVU49
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:57:       call_nr++;
	.loc 1 57 14 is_stmt 0 view .LVU50
	ldr	r3, [r4, #4]	@ call_nr, call_nr
	adds	r3, r3, #1	@ tmp152, call_nr,
	str	r3, [r4, #4]	@ tmp152, call_nr
	.loc 1 58 7 is_stmt 1 view .LVU51
	b	.L7		@
.L8:
	.loc 1 72 7 view .LVU52
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:72:       if(GET_RUNNING_TASK()->idle_task != False)
	.loc 1 72 10 is_stmt 0 view .LVU53
	bl	GET_RUNNING_TASK		@
.LVL16:
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:72:       if(GET_RUNNING_TASK()->idle_task != False)
	.loc 1 72 40 view .LVU54
	ldrb	r3, [r0]	@ zero_extendqisi2	@ *_41, *_41
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:72:       if(GET_RUNNING_TASK()->idle_task != False)
	.loc 1 72 9 view .LVU55
	lsls	r3, r3, #29	@, *_41,
	.loc 1 74 10 is_stmt 1 view .LVU56
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:74:          call_nr = 0;
	.loc 1 74 18 is_stmt 0 view .LVU57
	itt	mi
	movmi	r3, #0	@ tmp172,
	strmi	r3, [r4, #4]	@ tmp172, call_nr
	b	.L7		@
.L10:
	.loc 1 68 7 is_stmt 1 view .LVU58
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:68:       call_nr++;
	.loc 1 68 14 is_stmt 0 view .LVU59
	movs	r3, #4	@ tmp165,
	str	r3, [r4, #4]	@ tmp165, call_nr
	.loc 1 69 7 is_stmt 1 view .LVU60
	b	.L7		@
.L11:
	.loc 1 64 7 view .LVU61
	ldr	r0, .L27+24	@,
	bl	OS_ACTIVATE_TASK		@
.LVL17:
	.loc 1 65 7 view .LVU62
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:65:       call_nr++;
	.loc 1 65 14 is_stmt 0 view .LVU63
	ldr	r3, [r4, #4]	@ call_nr, call_nr
	adds	r3, r3, #1	@ tmp162, call_nr,
	str	r3, [r4, #4]	@ tmp162, call_nr
	.loc 1 66 7 is_stmt 1 view .LVU64
	b	.L7		@
.L12:
	.loc 1 60 7 view .LVU65
	ldr	r0, .L27+28	@,
	bl	OS_ACTIVATE_TASK		@
.LVL18:
	.loc 1 61 7 view .LVU66
@ C:\Users\president\Desktop\sbx\input\src\os_base\os_main.c:61:       call_nr++;
	.loc 1 61 14 is_stmt 0 view .LVU67
	ldr	r3, [r4, #4]	@ call_nr, call_nr
	adds	r3, r3, #1	@ tmp157, call_nr,
	str	r3, [r4, #4]	@ tmp157, call_nr
	.loc 1 62 7 is_stmt 1 view .LVU68
	b	.L7		@
.L28:
	.align	2
.L27:
...
.LFE1:
	...
	.data
	.set	.LANCHOR1,. + 0
	.type	sys_req_reset_state.4209, %object
	.size	sys_req_reset_state.4209, 1
sys_req_reset_state.4209:
	.byte	1
	.bss
	.align	2
	.set	.LANCHOR0,. + 0
	.type	call_nr.4210, %object
	.size	call_nr.4210, 4
call_nr.4210:
	.space	4
	.type	call_nr.4198, %object
	.size	call_nr.4198, 4
call_nr.4198:
	.space	4
	.text
.Letext0:
	...
	.file 11 "C:\\Users\\president\\Desktop\\sbx\\input\\src\\os_base\\os_task_queue.h"
	.file 12 "c:\\users\\president\\desktop\\sbx\\input\\src\\os_drivers\\lld_global.h"
	.file 13 "C:\\Users\\president\\Desktop\\sbx\\input\\src\\os_base\\os_stack.h"
	.file 14 "C:\\Users\\president\\Desktop\\sbx\\input\\src\\os_base\\os_start_init_mc.h"
	.file 15 "C:\\Users\\president\\Desktop\\sbx\\input\\src\\os_base\\os_start_init_hw.h"
	.file 16 "C:\\Users\\president\\Desktop\\sbx\\input\\src\\os_base\\os_start_init_sw.h"
...
.Ldebug_info0:
	...
	.uleb128 0x5
	.byte	0x3
	.4byte	sys_req_reset_state.4209
	.uleb128 0x15
	.4byte	.LASF715
	.byte	0x1
	.byte	0x57
...
.Ldebug_macro0:
	...
	.uleb128 0
	.uleb128 0x1
	.file 17 "C:\\Users\\president\\Desktop\\sbx\\input\\src\\os_base\\os_firstinc.h"
	.byte	0x3
	.uleb128 0x1
	.uleb128 0x11
	.byte	0x5
	.uleb128 0x2
	.4byte	.LASF447
	.file 18 "c:\\users\\president\\desktop\\sbx\\input\\src\\os_config.h"
	.byte	0x3
	.uleb128 0x4
	.uleb128 0x12
	.byte	0x7
	...
	.uleb128 0x2
	.4byte	.LASF502
	.file 19 "c:\\users\\president\\desktop\\sbx\\input\\src\\os_base\\os_firstinc.h"
	.byte	0x3
	.uleb128 0x3
	.uleb128 0x13
	.byte	0x4
	...
	.4byte	.LASF521
	.byte	0x4
	.file 23 "C:\\Users\\president\\Desktop\\sbx\\input\\src\\os_base\\os_heap.h"
	.byte	0x3
	.uleb128 0x6
	.uleb128 0x17
	.byte	0x5
	...
	.4byte	.LASF523
	.byte	0x4
	.file 24 "C:\\Users\\president\\Desktop\\sbx\\input\\src\\os_base\\os_task_common.h"
	.byte	0x3
	.uleb128 0x9
	.uleb128 0x18
	.byte	0x4
