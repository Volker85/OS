...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:94:    switch(OS_STATE)
	.loc 1 94 0
	ldr	r5, .L22	@ tmp171,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:89: {
	.loc 1 89 0
	push	{r3, lr}	@
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:94:    switch(OS_STATE)
	.loc 1 94 0
	ldr	r3, [r5]	@ OS_STATE.0_1, OS_STATE
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:136:       switch(sys_req_reset_state)
	...
	bne	.L20	@,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:150:          OS_Shutdown(os_reset_exit);
	.loc 1 150 0
	bl	OS_Shutdown	@
.LVL1:
.L2:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:167:    OS_StackCheck();
	.loc 1 167 0
	bl	OS_StackCheck	@
.LVL2:
.L16:
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:112:       OS_STATE = os_running;
	.loc 1 112 0
	movs	r3, #1	@ tmp126,
	str	r3, [r5]	@ tmp126, OS_STATE
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:114:       LLF_INT_ENABLE();
	.loc 1 114 0
	bl	LLF_INT_ENABLE	@
.LVL10:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:115:       break;
	.loc 1 115 0
	b	.L2	@
.L3:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:119:       if(call_nr % 5 == 0)
	.loc 1 119 0
	ldr	r4, .L22+4	@ tmp172,
	ldr	r2, [r4]	@ call_nr, call_nr
	movs	r3, #5	@ tmp133,
	udiv	r3, r2, r3	@ tmp132, call_nr, tmp133
	add	r3, r3, r3, lsl #2	@ tmp136, tmp132, tmp132,
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:125:       OS_TaskDispatcher();
	.loc 1 125 0
	bl	OS_TaskDispatcher	@
.LVL11:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:126:       if(SYSTEM_STATE_ACCEPTED == os_shutdown) /* check for shutdown/reset/exit conditions: currently shutdown is not planned to be supported... */
	.loc 1 126 0
	...
	bne	.L2	@,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:129:          sys_req_reset_state = Reset_restart;
	.loc 1 129 0
	movs	r2, #1	@ tmp167,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:128:          OS_STATE = os_shutdown;
	.loc 1 128 0
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:129:          sys_req_reset_state = Reset_restart;
	...
	b	.L2	@
.L20:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:145:          OS_Shutdown(os_reset_hardreset);
	.loc 1 145 0
	movs	r0, #0	@,
	bl	OS_Shutdown	@
.LVL12:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:146:          break;
	...
	b	.L2	@
.L14:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:140:          OS_Shutdown(os_reset_powerdown);
	.loc 1 140 0
	movs	r0, #1	@,
	bl	OS_Shutdown	@
.LVL13:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:141:          break;
	.loc 1 141 0
	b	.L2	@
.L21:
.LBB4:
.LBB5:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:59:     switch(call_nr)
	.loc 1 59 0
...
.L8:
	...
	.p2align 1
.L7:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:62:         OS_ActivateTask(&TASK_1_VAR);
	.loc 1 62 0
	ldr	r0, .L22+16	@,
	bl	OS_ActivateTask	@
.LVL14:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:63:         call_nr++;
	.loc 1 63 0
	ldr	r3, [r4, #4]	@ call_nr, call_nr
	adds	r3, r3, #1	@ tmp143, call_nr,
	str	r3, [r4, #4]	@ tmp143, call_nr
	b	.L6	@
.L12:
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:70:         OS_ActivateTask(&TASK_2_VAR);
	...
	bl	OS_ActivateTask	@
.LVL16:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:71:         call_nr++;
	.loc 1 71 0
	ldr	r3, [r4, #4]	@ call_nr, call_nr
	adds	r3, r3, #1	@ tmp150, call_nr,
	str	r3, [r4, #4]	@ tmp150, call_nr
	b	.L6	@
.L9:
...
call_nr.4111:
	.space	4
	.type	sys_req_reset_state.4122, %object
	.size	sys_req_reset_state.4122, 1
sys_req_reset_state.4122:
	.space	1
	.text
.Letext0:
	...
	.file 12 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_start_init_mc.h"
	.file 13 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_start_init_hw.h"
	.file 14 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_start_init_sw.h"
	.file 15 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_task_queue.h"
...
.Ldebug_info0:
	...
	.uleb128 0x5
	.byte	0x3
	.4byte	sys_req_reset_state.4122
	.uleb128 0x16
	.4byte	.LASF650
	.byte	0x1
	.byte	0x5c
...
.Ldebug_macro0:
	...
	.uleb128 0
	.uleb128 0x1
	.file 16 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_firstinc.h"
	.byte	0x3
	.uleb128 0x1
	.uleb128 0x10
	.byte	0x5
	...
	.byte	0x4
	.byte	0x4
	.file 23 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_task_common.h"
	.byte	0x3
	.uleb128 0x2
	.uleb128 0x17
	.byte	0x4
