...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c
@ -mcpu=cortex-m4 -mthumb
@ -auxbase-strip E:\NeuOrga\Programmieren\c_cpp\github_os\output\os_base\obj_arm\os_main.s
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:89:    switch(OS_STATE)
	.loc 1 89 0
	ldr	r5, .L28	@ tmp187,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:84: {
	.loc 1 84 0
	push	{r3, lr}	@
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:89:    switch(OS_STATE)
	.loc 1 89 0
	ldrb	r3, [r5]	@ zero_extendqisi2	@ OS_STATE, OS_STATE
	uxtb	r3, r3	@ OS_STATE.0_1, OS_STATE
	cmp	r3, #1	@ OS_STATE.0_1,
	beq	.L3	@,
	bcc	.L4	@,
	cmp	r3, #2	@ OS_STATE.0_1,
	bne	.L2	@,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:135:       LLF_INT_DISABLE();
	.loc 1 135 0
	bl	LLF_INT_DISABLE	@
.LVL0:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:136:       switch(sys_req_reset_state)
	.loc 1 136 0
	ldr	r3, .L28+4	@ tmp185,
	ldrb	r0, [r3]	@ zero_extendqisi2	@ sys_req_reset_state, sys_req_reset_state
	cmp	r0, #1	@ sys_req_reset_state,
	beq	.L18	@,
	bcc	.L17	@,
	cmp	r0, #2	@ sys_req_reset_state,
	bne	.L26	@,
.L18:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:150:          OS_SHUTDOWN(E_OS_RESET_EXIT,0u);
	.loc 1 150 0
	movs	r1, #0	@,
	bl	OS_SHUTDOWN	@
.LVL1:
.L2:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:168:    OS_STACK_CHECK();
	.loc 1 168 0
	bl	OS_STACK_CHECK	@
.LVL2:
.L19:
	b	.L19	@
.L4:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:94:       OS_INIT_MC();
	.loc 1 94 0
	bl	OS_INIT_MC	@
.LVL3:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:97:       OS_INIT_HW();
	.loc 1 97 0
	bl	OS_INIT_HW	@
.LVL4:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:98:       OS_INIT_SW();
	.loc 1 98 0
	bl	OS_INIT_SW	@
.LVL5:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:103:       OS_ACTIVATE_TASK(&TASK_0_VAR);
	.loc 1 103 0
	ldr	r0, .L28+8	@,
	bl	OS_ACTIVATE_TASK	@
.LVL6:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:104:       OS_START_TASK(GET_IDLE_TASK(),0u);
	.loc 1 104 0
	bl	GET_IDLE_TASK	@
.LVL7:
	movs	r1, #0	@,
	bl	OS_START_TASK	@
.LVL8:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:105:       OS_ACTIVATE_DISPATCHER();
	.loc 1 105 0
	bl	OS_ACTIVATE_DISPATCHER	@
.LVL9:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:107:       OS_STATE = OS_STATE_RUNNING;
	.loc 1 107 0
	movs	r3, #1	@ tmp133,
	strb	r3, [r5]	@ tmp133, OS_STATE
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:109:       LLF_INT_ENABLE();
	.loc 1 109 0
	bl	LLF_INT_ENABLE	@
.LVL10:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:110:       break;
	.loc 1 110 0
	b	.L2	@
.L3:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:119:       if(call_nr % 5u == 0u)
	.loc 1 119 0
	ldr	r4, .L28+12	@ tmp188,
	ldr	r2, [r4]	@ call_nr, call_nr
	movs	r3, #5	@ tmp141,
	udiv	r3, r2, r3	@ tmp140, call_nr, tmp141
	add	r3, r3, r3, lsl #2	@ tmp144, tmp140, tmp140,
	cmp	r2, r3	@ call_nr, tmp144
	beq	.L27	@,
.L7:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:123:       call_nr++;
	.loc 1 123 0
	ldr	r3, [r4]	@ call_nr, call_nr
	adds	r3, r3, #1	@ tmp174, call_nr,
	str	r3, [r4]	@ tmp174, call_nr
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:125:       OS_TASK_DISPATCHER();
	.loc 1 125 0
	bl	OS_TASK_DISPATCHER	@
.LVL11:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:126:       if(SYSTEM_STATE_ACCEPTED == OS_STATE_SHUTDOWN) /* check for shutdown/reset/exit conditions: currently shutdown is not planned to be supported... */
	.loc 1 126 0
	ldr	r3, .L28+16	@ tmp176,
	...
	bne	.L2	@,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:129:          sys_req_reset_state = E_OS_RESET_HARDRESET;
	.loc 1 129 0
	ldr	r2, .L28+4	@ tmp182,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:128:          OS_STATE = OS_STATE_SHUTDOWN;
	.loc 1 128 0
	strb	r3, [r5]	@ SYSTEM_STATE_ACCEPTED.3_7, OS_STATE
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:129:          sys_req_reset_state = E_OS_RESET_HARDRESET;
	.loc 1 129 0
	movs	r3, #0	@ tmp183,
	strb	r3, [r2]	@ tmp183, sys_req_reset_state
	b	.L2	@
.L26:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:155:          OS_SHUTDOWN(E_OS_RESET_HARDRESET,0u);
	.loc 1 155 0
	movs	r1, #0	@,
	mov	r0, r1	@,
	bl	OS_SHUTDOWN	@
.LVL12:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:156:          OS_SET_SW_BUG(E_OS_BUG_RESET_EXIT_OR_SHUTDOWN_FAILED,E_FUNC_STATE_HANDLER);
	.loc 1 156 0
	movs	r1, #19	@,
	movs	r0, #8	@,
	bl	OS_SET_SW_BUG	@
.LVL13:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:157:          break;
	.loc 1 157 0
	b	.L2	@
.L17:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:145:          OS_SHUTDOWN(E_OS_RESET_HARDRESET,0u);
	.loc 1 145 0
	movs	r1, #0	@,
	mov	r0, r1	@,
	bl	OS_SHUTDOWN	@
.LVL14:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:146:          break;
	.loc 1 146 0
	b	.L2	@
.L27:
.LBB4:
.LBB5:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:53:    switch(call_nr)
	.loc 1 53 0
	ldr	r3, [r4, #4]	@ call_nr, call_nr
	cmp	r3, #4	@ call_nr,
	bhi	.L7	@
	tbb	[pc, r3]	@ call_nr
.L9:
	...
	.p2align 1
.L8:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:56:       OS_ACTIVATE_TASK(&TASK_1_VAR);
	.loc 1 56 0
	ldr	r0, .L28+20	@,
	bl	OS_ACTIVATE_TASK	@
.LVL15:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:57:       call_nr++;
	.loc 1 57 0
	ldr	r3, [r4, #4]	@ call_nr, call_nr
	adds	r3, r3, #1	@ tmp151, call_nr,
	str	r3, [r4, #4]	@ tmp151, call_nr
	b	.L7	@
.L13:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:72:       if(GET_RUNNING_TASK()->idle_task != False)
	.loc 1 72 0
	bl	GET_RUNNING_TASK	@
.LVL16:
	ldrb	r3, [r0]	@ zero_extendqisi2	@ *_41, *_41
	lsls	r3, r3, #29	@, *_41,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:74:          call_nr = 0;
	.loc 1 74 0
	itt	mi
	movmi	r3, #0	@ tmp171,
	strmi	r3, [r4, #4]	@ tmp171, call_nr
	b	.L7	@
.L12:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:68:       call_nr++;
	.loc 1 68 0
	movs	r3, #4	@ tmp164,
	str	r3, [r4, #4]	@ tmp164, call_nr
	b	.L7	@
.L11:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:64:       OS_ACTIVATE_TASK(&TASK_3_VAR);
	.loc 1 64 0
	ldr	r0, .L28+24	@,
	bl	OS_ACTIVATE_TASK	@
.LVL17:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:65:       call_nr++;
	.loc 1 65 0
	ldr	r3, [r4, #4]	@ call_nr, call_nr
	adds	r3, r3, #1	@ tmp161, call_nr,
	str	r3, [r4, #4]	@ tmp161, call_nr
	b	.L7	@
.L10:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:60:       OS_ACTIVATE_TASK(&TASK_2_VAR);
	.loc 1 60 0
	ldr	r0, .L28+28	@,
	bl	OS_ACTIVATE_TASK	@
.LVL18:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:61:       call_nr++;
	.loc 1 61 0
	ldr	r3, [r4, #4]	@ call_nr, call_nr
	adds	r3, r3, #1	@ tmp156, call_nr,
	str	r3, [r4, #4]	@ tmp156, call_nr
	b	.L7	@
.L29:
	.align	2
.L28:
...
.LFE1:
	...
	.data
	.set	.LANCHOR1,. + 0
	.type	sys_req_reset_state.4167, %object
	.size	sys_req_reset_state.4167, 1
sys_req_reset_state.4167:
	.byte	1
	.bss
	.align	2
	.set	.LANCHOR0,. + 0
	.type	call_nr.4168, %object
	.size	call_nr.4168, 4
call_nr.4168:
	.space	4
	.type	call_nr.4156, %object
	.size	call_nr.4156, 4
call_nr.4156:
	.space	4
	.text
.Letext0:
	...
	.file 11 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_task_queue.h"
	...
	.file 14 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_start_init_mc.h"
	.file 15 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_start_init_hw.h"
	.file 16 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_start_init_sw.h"
...
.Ldebug_info0:
	...
	.uleb128 0x5
	.byte	0x3
	.4byte	sys_req_reset_state.4167
	.uleb128 0x15
	.4byte	.LASF705
	.byte	0x1
	.byte	0x57
...
.Ldebug_macro0:
	...
	.uleb128 0
	.uleb128 0x1
	.file 17 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_firstinc.h"
	.byte	0x3
	.uleb128 0x1
	.uleb128 0x11
	.byte	0x5
	...
	.4byte	.Ldebug_macro7
	.byte	0x4
	.file 25 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_main.h"
	.byte	0x3
	.uleb128 0xa
	.uleb128 0x19
	.byte	0x4
...
.LASF522:
	.ascii	"_OS_START_INIT_HW_H_ \000"
.LASF516:
...
.LASF523:
	.ascii	"_OS_START_INIT_SW_H_ \000"
.LASF486:
