...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:137:       switch(sys_req_reset_state)
	...
	bne	.L21	@,
.L16:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:151:          OS_SHUTDOWN(E_OS_RESET_EXIT,0u);
	.loc 1 151 0
	movs	r1, #0	@,
	bl	OS_SHUTDOWN	@
.LVL1:
.L2:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:169:    OS_STACK_CHECK();
	.loc 1 169 0
	bl	OS_STACK_CHECK	@
.LVL2:
.L17:
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:110:       break;
	...
	b	.L2	@
.L3:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:120:       if(call_nr % 5u == 0u)
	.loc 1 120 0
	ldr	r4, .L23+12	@ tmp176,
	ldr	r2, [r4]	@ call_nr, call_nr
	movs	r3, #5	@ tmp136,
	udiv	r3, r2, r3	@ tmp135, call_nr, tmp136
	add	r3, r3, r3, lsl #2	@ tmp139, tmp135, tmp135,
	cmp	r2, r3	@ call_nr, tmp139
	beq	.L22	@,
.L6:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:124:       call_nr++;
	...
	str	r3, [r4]	@ tmp162, call_nr
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:126:       OS_TASK_DISPATCHER();
	.loc 1 126 0
	bl	OS_TASK_DISPATCHER	@
.LVL11:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:127:       if(SYSTEM_STATE_ACCEPTED == OS_STATE_SHUTDOWN) /* check for shutdown/reset/exit conditions: currently shutdown is not planned to be supported... */
	.loc 1 127 0
	ldr	r3, .L23+16	@ tmp164,
	...
	bne	.L2	@,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:130:          sys_req_reset_state = E_OS_RESET_HARDRESET;
	.loc 1 130 0
	ldr	r2, .L23+4	@ tmp170,
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:129:          OS_STATE = OS_STATE_SHUTDOWN;
	.loc 1 129 0
	strb	r3, [r5]	@ SYSTEM_STATE_ACCEPTED.3_7, OS_STATE
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:130:          sys_req_reset_state = E_OS_RESET_HARDRESET;
	.loc 1 130 0
	movs	r3, #0	@ tmp171,
	strb	r3, [r2]	@ tmp171, sys_req_reset_state
	b	.L2	@
.L21:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:156:          OS_SHUTDOWN(E_OS_RESET_HARDRESET,0u);
	.loc 1 156 0
	movs	r1, #0	@,
	mov	r0, r1	@,
	bl	OS_SHUTDOWN	@
.LVL12:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:157:          OS_SET_SW_BUG(E_OS_BUG_RESET_EXIT_OR_SHUTDOWN_FAILED,E_FUNC_STATE_HANDLER);
	.loc 1 157 0
	movs	r1, #19	@,
	movs	r0, #8	@,
	bl	OS_SET_SW_BUG	@
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:158:          break;
	...
	b	.L2	@
.L15:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:146:          OS_SHUTDOWN(E_OS_RESET_HARDRESET,0u);
	.loc 1 146 0
	movs	r1, #0	@,
	mov	r0, r1	@,
	bl	OS_SHUTDOWN	@
...
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:57:       call_nr++;
	.loc 1 57 0
	ldr	r3, [r4, #4]	@ call_nr, call_nr
	adds	r3, r3, #1	@ tmp146, call_nr,
	str	r3, [r4, #4]	@ tmp146, call_nr
	b	.L6	@
.L12:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:72:       OS_ACTIVATE_TASK(&TASK_3_VAR);
	.loc 1 72 0
	ldr	r0, .L23+24	@,
	bl	OS_ACTIVATE_TASK	@
.LVL16:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:73:       call_nr = 0u;
	.loc 1 73 0
	movs	r3, #0	@ tmp159,
	str	r3, [r4, #4]	@ tmp159, call_nr
	b	.L6	@
.L11:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:69:       call_nr++;
	.loc 1 69 0
	movs	r3, #4	@ tmp156,
	str	r3, [r4, #4]	@ tmp156, call_nr
	b	.L6	@
.L10:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:64:       OS_ACTIVATE_TASK(&TASK_2_VAR);
	.loc 1 64 0
	ldr	r0, .L23+28	@,
	bl	OS_ACTIVATE_TASK	@
.LVL17:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:65:       call_nr++;
	.loc 1 65 0
	ldr	r3, [r4, #4]	@ call_nr, call_nr
	adds	r3, r3, #1	@ tmp153, call_nr,
	str	r3, [r4, #4]	@ tmp153, call_nr
	b	.L6	@
.L9:
@ E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_base\os_main.c:61:       call_nr++;
	.loc 1 61 0
	movs	r3, #2	@ tmp149,
	str	r3, [r4, #4]	@ tmp149, call_nr
	b	.L6	@
.L24:
	.align	2
.L23:
...
.LFE1:
	...
	.data
	.set	.LANCHOR1,. + 0
	.type	sys_req_reset_state.4142, %object
	.size	sys_req_reset_state.4142, 1
sys_req_reset_state.4142:
	.byte	1
	.bss
	.align	2
	.set	.LANCHOR0,. + 0
	.type	call_nr.4143, %object
	.size	call_nr.4143, 4
call_nr.4143:
	.space	4
...
.Letext0:
	...
	.file 13 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_start_init_mc.h"
	.file 14 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_start_init_hw.h"
	.file 15 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_start_init_sw.h"
	.file 16 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_task_queue.h"
...
.Ldebug_info0:
	...
	.uleb128 0x5
	.byte	0x3
	.4byte	sys_req_reset_state.4142
	.uleb128 0x16
	.4byte	.LASF672
	.byte	0x1
	.byte	0x57
