...
LFE0:
.lcomm ___sput,76,32
	.def	_test_01_start_os;	.scl	3;	.type	32;	.endef
_test_01_start_os:
LFB10:
	.file 2 "E:/NeuOrga/Programmieren/c_cpp/github_os/input/src/os_test/mcu_start.c"
	.loc 2 6 0
	.cfi_startproc
	pushl	%ebp
	.cfi_def_cfa_offset 8
	...
	subl	$8, %esp
	.loc 2 8 0
	call	_OS_Exception_RESET
L4:
	.loc 2 11 0 discriminator 1
	call	_OS_Exception_Systick
...
L7:
	...
	call	_memset
	movl	$LC2, ___sput+44
	call	_test_01_start_os
LBB2:
	.loc 2 23 0 is_stmt 1 discriminator 4
	movl	LC3, %eax
	movl	%eax, 108(%esp)
	movb	___sput+4, %al
	cmpb	$6, %al
...
LBB3:
	...
	call	_exit
L10:
	.loc 2 23 0 discriminator 6
	movl	___sput+24, %eax
	testl	%eax, %eax
	jne	L11
	.loc 2 23 0 discriminator 7
	movl	___sput, %eax
	movl	%eax, 12(%esp)
	movl	$27, 8(%esp)
	movl	$1, 4(%esp)
	...
	call	_exit
L11:
	.loc 2 23 0 discriminator 8
	movl	___sput+32, %eax
	testl	%eax, %eax
	je	L12
	.loc 2 23 0 discriminator 9
	movl	___sput+40, %eax
	movl	%eax, 72(%esp)
	movl	$0, 76(%esp)
	fildq	72(%esp)
	...
	jmp	L13
L12:
	.loc 2 23 0 discriminator 10
	movl	LC3, %eax
L13:
	.loc 2 23 0 discriminator 12
	movl	%eax, 104(%esp)
	flds	104(%esp)
	fstpl	72(%esp)
	movl	72(%esp), %eax
...
L9:
LBE3:
	.loc 2 23 0 discriminator 13
	movl	___sput+8, %eax
	testl	%eax, %eax
	je	L14
	.loc 2 23 0 discriminator 14
	movl	___sput+20, %eax
	movl	%eax, 72(%esp)
	movl	$0, 76(%esp)
	fildq	72(%esp)
	...
	jmp	L15
L14:
	.loc 2 23 0 discriminator 15
	movl	LC3, %eax
L15:
	.loc 2 23 0 discriminator 17
	movl	%eax, 108(%esp)
	movl	$0, (%esp)
	call	_time
	movl	%eax, ___sput+72
	...
	testl	%eax, %eax
	jne	L16
	.loc 2 23 0 discriminator 18
	movl	$LC6, 72(%esp)
	jmp	L17
L16:
	.loc 2 23 0 discriminator 19
	movl	$LC7, 72(%esp)
L17:
	.loc 2 23 0 discriminator 21
	flds	108(%esp)
	fstpl	64(%esp)
	movl	64(%esp), %ebx
	movl	68(%esp), %esi
	...
	call	_fprintf
LBE2:
	.loc 2 25 0 is_stmt 1 discriminator 21
	movl	___sput+20, %eax
	testl	%eax, %eax
	setne	%al
	movzbl	%al, %eax
	.loc 2 26 0 discriminator 21
	leal	-12(%ebp), %esp
	popl	%ebx
	.cfi_restore 3
	popl	%esi
...
Letext0:
	...
	.file 4 "E:/NeuOrga/Programmieren/c_cpp/github_os/input/src/os_test/sput.h"
...
Ldebug_info0:
	...
	.byte	0x1
	.ascii "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_test\\mcu_start.c\0"
	.long	Ltext0
	.long	Letext0-Ltext0
...
Ldebug_macro0:
	...
	.byte	0x4
	.file 8 "E:/NeuOrga/Programmieren/c_cpp/github_os/input/src/os_test/../os_base/os_exception_isr_handler.h"
	.byte	0x3
	.uleb128 0x2
	.uleb128 0x8
	.byte	0x1
	...
	.uleb128 0x26
	.ascii "HAVE_SPUT_H \0"
	.file 9 "d:/programm/mingw/include/stdlib.h"
	.byte	0x3
	.uleb128 0x2f
	.uleb128 0x9
	.byte	0x1
	...
	.byte	0x4
	.file 10 "d:/programm/mingw/include/string.h"
	.byte	0x3
	.uleb128 0x30
	.uleb128 0xa
	.byte	0x1
	...
	.byte	0x4
	.file 11 "d:/programm/mingw/include/time.h"
	.byte	0x3
	.uleb128 0x31
	.uleb128 0xb
	.byte	0x1
