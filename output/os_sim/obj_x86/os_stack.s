...
LFB0:
	...
	.loc 1 16 18
	movl	$0, _stack_pos.1451
	.loc 1 16 4
	jmp	L2
L4:
	.loc 1 18 23
	movl	_stack_pos.1451, %eax
	movb	_OS_MAIN_STACK(%eax), %al
	.loc 1 18 9
	cmpb	$-86, %al
	je	L3
	.loc 1 20 21
	movl	$1, _stack_used.1452
	.loc 1 21 23
	movl	_stack_pos.1451, %edx
...
L3:
	.loc 1 16 64 discriminator 2
	movl	_stack_pos.1451, %eax
	incl	%eax
	movl	%eax, _stack_pos.1451
L2:
	.loc 1 16 33 discriminator 1
	movl	_stack_pos.1451, %eax
	.loc 1 16 4 discriminator 1
	cmpl	$1023, %eax
	jbe	L4
	.loc 1 28 18
	movl	$0, _stack_pos.1451
...
L17:
	...
	.loc 1 95 19
	movl	_stack_used.1452, %eax
	.loc 1 95 6
	cmpl	$1, %eax
	jne	L23
	.loc 1 95 61 discriminator 1
	movl	_OS_MAIN_STACK_USAGE_PERCENT, %eax
	.loc 1 95 28 discriminator 1
	cmpl	$80, %eax
	ja	L21
	.loc 1 95 98 discriminator 2
	movl	_TASK0_STACK_USAGE_PERCENT, %eax
	.loc 1 95 68 discriminator 2
	cmpl	$80, %eax
	ja	L21
	.loc 1 95 135 discriminator 3
	movl	_TASK1_STACK_USAGE_PERCENT, %eax
	.loc 1 95 105 discriminator 3
	cmpl	$80, %eax
	ja	L21
	.loc 1 95 172 discriminator 4
	movl	_TASK2_STACK_USAGE_PERCENT, %eax
	.loc 1 95 142 discriminator 4
	cmpl	$80, %eax
	ja	L21
	.loc 1 95 209 discriminator 5
	movl	_TASK3_STACK_USAGE_PERCENT, %eax
	.loc 1 95 179 discriminator 5
	cmpl	$80, %eax
	ja	L21
	.loc 1 95 246 discriminator 6
	movl	_TASK4_STACK_USAGE_PERCENT, %eax
	.loc 1 95 216 discriminator 6
	cmpl	$80, %eax
	jbe	L23
L21:
	.loc 1 97 7
...
L23:
	...
	.cfi_endproc
LFE0:
	.globl	_OS_STACK_CHK_PATTERN_INIT
...
L26:
	...
	addl	$_OS_MAIN_STACK, %eax
	movb	$-86, (%eax)
	.loc 1 110 71 discriminator 3
	incl	-4(%ebp)
L25:
	.loc 1 110 4 discriminator 1
	cmpl	$959, -4(%ebp)
	jbe	L26
	.loc 1 114 18
	movl	$0, -4(%ebp)
...
L34:
	...
	addl	$_TASK3_STACK, %eax
	movb	$-86, (%eax)
	.loc 1 126 69 discriminator 3
	incl	-4(%ebp)
L33:
	.loc 1 126 4 discriminator 1
	cmpl	$1935, -4(%ebp)
	jbe	L34
	.loc 1 130 18
	movl	$0, -4(%ebp)
...
L36:
	...
	addl	$_TASK4_STACK, %eax
	movb	$-86, (%eax)
	.loc 1 130 69 discriminator 3
	incl	-4(%ebp)
L35:
	.loc 1 130 4 discriminator 1
	cmpl	$1935, -4(%ebp)
	jbe	L36
	.loc 1 134 1
	nop
	...
	.cfi_endproc
LFE1:
.lcomm _stack_pos.1451,4,4
.lcomm _stack_used.1452,4,4
Letext0:
...
Ldebug_info0:
	...
	.byte	0x1
	.ascii "C:\\Users\\president\\Desktop\\sbx\\input\\src\\os_base\\os_stack.c\0"
