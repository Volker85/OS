	...
	.text
Ltext0:
	.globl	_OS_StackCheck
	.def	_OS_StackCheck;	.scl	2;	.type	32;	.endef
_OS_StackCheck:
LFB0:
	.file 1 "E:/NeuOrga/Programmieren/c_cpp/github_os/input/src/os_base/os_stack.c"
	.loc 1 4 0
	.cfi_startproc
	pushl	%ebp
	...
	subl	$24, %esp
	.loc 1 13 0
	movl	$0, _stack_pos.1317
	jmp	L2
L7:
	.loc 1 15 0
	movl	$0, _nr_of_cores.1318
	jmp	L3
L5:
	.loc 1 17 0
	movl	_nr_of_cores.1318, %edx
	movl	_stack_pos.1317, %ecx
	movl	%edx, %eax
	sall	$2, %eax
	addl	%edx, %eax
	sall	$12, %eax
...
L4:
	...
	movl	_nr_of_cores.1318, %eax
	incl	%eax
	movl	%eax, _nr_of_cores.1318
L3:
...
LFB1:
	...
	.cfi_def_cfa_register 5
	.loc 1 39 0
	movl	$0, _stack_pos.1330
	jmp	L11
L14:
	.loc 1 41 0
	movl	$0, _nr_of_cores.1331
	jmp	L12
L13:
	.loc 1 43 0 discriminator 3
	movl	_nr_of_cores.1331, %edx
	movl	_stack_pos.1330, %ecx
	movl	%edx, %eax
	sall	$2, %eax
	addl	%edx, %eax
	sall	$12, %eax
	...
	movl	_nr_of_cores.1331, %eax
	incl	%eax
	movl	%eax, _nr_of_cores.1331
L12:
...
L11:
	...
	.cfi_endproc
LFE1:
.lcomm _stack_pos.1317,4,4
.lcomm _nr_of_cores.1318,4,4
.lcomm _failed.1319,4,4
.lcomm _stack_pos.1330,4,4
.lcomm _nr_of_cores.1331,4,4
Letext0:
...
Ldebug_info0:
	...
	.byte	0x1
	.ascii "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_base\\os_stack.c\0"
	.long	Ltext0
	.long	Letext0-Ltext0
