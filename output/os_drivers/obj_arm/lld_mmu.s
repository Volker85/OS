...
.Ltext0:
	...
	.thumb
	.thumb_func
	.type	LLF_MPU_DISABLE, %function
LLF_MPU_DISABLE:
.LFB0:
	.file 1 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_drivers\\lld_mmu.c"
	.loc 1 5 0
	.cfi_startproc
	...
	.cfi_endproc
.LFE0:
	.size	LLF_MPU_DISABLE, .-LLF_MPU_DISABLE
	.align	2
	.global	LLF_MPU_ENABLE
	.thumb
	.thumb_func
	.type	LLF_MPU_ENABLE, %function
LLF_MPU_ENABLE:
.LFB1:
	.loc 1 10 0
	.cfi_startproc
	...
	.cfi_endproc
.LFE1:
	.size	LLF_MPU_ENABLE, .-LLF_MPU_ENABLE
	.align	2
	.global	LLF_MPU_SET_REGION
	.thumb
	.thumb_func
	.type	LLF_MPU_SET_REGION, %function
LLF_MPU_SET_REGION:
.LFB2:
	.loc 1 15 0
	.cfi_startproc
	...
	.cfi_endproc
.LFE2:
	.size	LLF_MPU_SET_REGION, .-LLF_MPU_SET_REGION
	.align	2
	.global	LLF_MPU_SWITCH_OFF_ALL_REGIONS
	.thumb
	.thumb_func
	.type	LLF_MPU_SWITCH_OFF_ALL_REGIONS, %function
...
.LFB3:
	...
	.cfi_endproc
.LFE3:
	.size	LLF_MPU_SWITCH_OFF_ALL_REGIONS, .-LLF_MPU_SWITCH_OFF_ALL_REGIONS
	.align	2
	.global	LLF_GET_MPU_PRESENT
	.thumb
	.thumb_func
	.type	LLF_GET_MPU_PRESENT, %function
LLF_GET_MPU_PRESENT:
.LFB4:
	.loc 1 28 0
	.cfi_startproc
...
.L9:
	...
	.cfi_endproc
.LFE4:
	.size	LLF_GET_MPU_PRESENT, .-LLF_GET_MPU_PRESENT
.Letext0:
...
.LASF439:
	.ascii	"endAddr\000"
.LASF424:
	.ascii	"MPU_TYPE ((unsigned_char_t*)0xE000ED90)\000"
.LASF63:
...
.LASF444:
	...
	.ascii	"\\src\\os_drivers\\lld_mmu.c\000"
.LASF141:
