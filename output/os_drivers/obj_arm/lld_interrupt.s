...
.Ltext0:
	...
	.thumb
	.thumb_func
	.type	LLF_INT_DISABLE, %function
LLF_INT_DISABLE:
.LFB0:
	.file 1 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_drivers\\lld_interrupt.c"
	.loc 1 6 0
	.cfi_startproc
	...
	.loc 1 10 0
@ 10 "E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_drivers\lld_interrupt.c" 1
	cpsid i
@ 0 "" 2
	.loc 1 12 0
	.thumb
	...
	.cfi_endproc
.LFE0:
	.size	LLF_INT_DISABLE, .-LLF_INT_DISABLE
	.align	2
	.global	LLF_INT_ENABLE
	.thumb
	.thumb_func
	.type	LLF_INT_ENABLE, %function
LLF_INT_ENABLE:
.LFB1:
	.loc 1 14 0
	.cfi_startproc
	...
	.cfi_def_cfa_register 7
	.loc 1 18 0
@ 18 "E:\NeuOrga\Programmieren\c_cpp\github_os\input\src\os_drivers\lld_interrupt.c" 1
	cpsie i
@ 0 "" 2
	.loc 1 20 0
	.thumb
	...
	.cfi_endproc
.LFE1:
	.size	LLF_INT_ENABLE, .-LLF_INT_ENABLE
	.align	2
	.global	LLF_DISABLE_INTERRUPTS_ALL_CORES
	.thumb
	.thumb_func
	.type	LLF_DISABLE_INTERRUPTS_ALL_CORES, %function
...
.LFB2:
	...
	.cfi_endproc
.LFE2:
	.size	LLF_DISABLE_INTERRUPTS_ALL_CORES, .-LLF_DISABLE_INTERRUPTS_ALL_CORES
.Letext0:
...
.LASF432:
	...
	.ascii	"\\src\\os_drivers\\lld_interrupt.c\000"
.LASF230:
