...
Get_core_id:
.LFB0:
	.file 1 "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_drivers\\lld_global.c"
	.loc 1 3 0
	.cfi_startproc
...
.LFE0:
	...
	.thumb
	.thumb_func
	.type	LLF_SAVE_TASK_STACK, %function
LLF_SAVE_TASK_STACK:
.LFB1:
	.loc 1 24 0
	.cfi_startproc
	...
	.cfi_endproc
.LFE1:
	.size	LLF_SAVE_TASK_STACK, .-LLF_SAVE_TASK_STACK
	.align	2
...
.LFB2:
	...
	.cfi_endproc
.LFE2:
	.size	LLF_SAVE_REGISTERS, .-LLF_SAVE_REGISTERS
	.align	2
...
.LFB3:
	...
	.cfi_endproc
.LFE3:
	.size	LLF_RESTORE_TASK_STACK, .-LLF_RESTORE_TASK_STACK
	.align	2
	.global	LLF_RESTORE_REGISTERS
	.thumb
	.thumb_func
	.type	LLF_RESTORE_REGISTERS, %function
...
.LFB4:
	...
	.cfi_endproc
.LFE4:
	.size	LLF_RESTORE_REGISTERS, .-LLF_RESTORE_REGISTERS
	.align	2
...
.LFB5:
	...
	.cfi_endproc
.LFE5:
	.size	LLF_RESTORE_SYSTEM_STACK, .-LLF_RESTORE_SYSTEM_STACK
	.align	2
...
.LFB6:
	...
	.cfi_endproc
.LFE6:
	.size	LLF_SAVE_SYSTEM_STACK, .-LLF_SAVE_SYSTEM_STACK
	.align	2
...
.LFB7:
	...
	.cfi_endproc
.LFE7:
	.size	LLF_CLEAR_ALL_GP_REGISTERS, .-LLF_CLEAR_ALL_GP_REGISTERS
	.align	2
...
.LFB8:
	...
	.cfi_endproc
.LFE8:
	.size	LLF_PERFORM_RAM_CHECK, .-LLF_PERFORM_RAM_CHECK
.Letext0:
