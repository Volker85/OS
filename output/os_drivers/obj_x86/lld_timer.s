	...
	.text
Ltext0:
.lcomm _COMPARE_VALUE_TCMP1,4,4
	.globl	_LLF_UP_CNT_TIMER_32
	.def	_LLF_UP_CNT_TIMER_32;	.scl	2;	.type	32;	.endef
_LLF_UP_CNT_TIMER_32:
LFB0:
	.file 1 "E:/NeuOrga/Programmieren/c_cpp/github_os/input/src/os_sim/lld_timer.c"
	.loc 1 7 0
	.cfi_startproc
	pushl	%ebp
...
LFB1:
	...
	.cfi_def_cfa_register 5
	.loc 1 12 0
	movl	_COMPARE_VALUE_TCMP1, %edx
	movl	8(%ebp), %eax
	addl	%edx, %eax
	movl	%eax, _COMPARE_VALUE_TCMP1
	.loc 1 13 0
	popl	%ebp
	.cfi_restore 5
	.cfi_def_cfa 4, 4
...
Ldebug_info0:
	...
	.byte	0x1
	.ascii "E:\\NeuOrga\\Programmieren\\c_cpp\\github_os\\input\\src\\os_sim\\lld_timer.c\0"
	.long	Ltext0
	.long	Letext0-Ltext0
	...
	.byte	0x9c
	.uleb128 0x8
	.ascii "COMPARE_VALUE_TCMP1\0"
	.byte	0x1
	.byte	0x4
	.long	0xe0
	.uleb128 0x5
	.byte	0x3
	.long	_COMPARE_VALUE_TCMP1
	.byte	0
