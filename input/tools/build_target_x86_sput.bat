...
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_common_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_common_test.o -o %OUTPUT_DIR%\VERSION_X86\os_common_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_common_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_const_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_const_test.o -o %OUTPUT_DIR%\VERSION_X86\os_const_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_const_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_exception_isr_handler_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_exception_isr_handler_test.o -o %OUTPUT_DIR%\VERSION_X86\os_exception_isr_handler_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_exception_isr_handler_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_exception_table_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_exception_table_test.o -o %OUTPUT_DIR%\VERSION_X86\os_exception_table_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_exception_table_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_exception_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_exception_test.o -o %OUTPUT_DIR%\VERSION_X86\os_exception_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_exception_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_heap_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_heap_test.o -o %OUTPUT_DIR%\VERSION_X86\os_heap_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_heap_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_init_task_system_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_init_task_system_test.o -o %OUTPUT_DIR%\VERSION_X86\os_init_task_system_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_init_task_system_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_main_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_main_test.o -o %OUTPUT_DIR%\VERSION_X86\os_main_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_main_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_memory_mmu_setup_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_memory_mmu_setup_test.o -o %OUTPUT_DIR%\VERSION_X86\os_memory_mmu_setup_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_memory_mmu_setup_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_ram_shared_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_ram_shared_test.o -o %OUTPUT_DIR%\VERSION_X86\os_ram_shared_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_ram_shared_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_ram_stack_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_ram_stack_test.o -o %OUTPUT_DIR%\VERSION_X86\os_ram_stack_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_ram_stack_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_ram_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_ram_test.o -o %OUTPUT_DIR%\VERSION_X86\os_ram_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_ram_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_shutdown_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_shutdown_test.o -o %OUTPUT_DIR%\VERSION_X86\os_shutdown_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_shutdown_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_stack_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_stack_test.o -o %OUTPUT_DIR%\VERSION_X86\os_stack_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_stack_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_start_ext_prg_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_start_ext_prg_test.o -o %OUTPUT_DIR%\VERSION_X86\os_start_ext_prg_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_start_ext_prg_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_start_init_hw_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_start_init_hw_test.o -o %OUTPUT_DIR%\VERSION_X86\os_start_init_hw_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_start_init_hw_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_start_init_mc_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_start_init_mc_test.o -o %OUTPUT_DIR%\VERSION_X86\os_start_init_mc_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_start_init_mc_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_start_init_sw_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_start_init_sw_test.o -o %OUTPUT_DIR%\VERSION_X86\os_start_init_sw_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_start_init_sw_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_start_os_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_start_os_test.o -o %OUTPUT_DIR%\VERSION_X86\os_start_os_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_start_os_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_task_common_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_task_common_test.o -o %OUTPUT_DIR%\VERSION_X86\os_task_common_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_task_common_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_task_queue_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_task_queue_test.o -o %OUTPUT_DIR%\VERSION_X86\os_task_queue_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_task_queue_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_task_scheduler_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_task_scheduler_test.o -o %OUTPUT_DIR%\VERSION_X86\os_task_scheduler_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_task_scheduler_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\lld_global_test.map -O0  %OUTPUT_DIR%\os_sim\obj_x86\lld_global_test.o -o %OUTPUT_DIR%\os_sim\lld_global_test.exe  >> %OUTPUT_DIR%\os_sim\lld_global_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\lld_interrupt_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\lld_interrupt_test.o -o %OUTPUT_DIR%\VERSION_X86\lld_interrupt_test.exe  >> %OUTPUT_DIR%\VERSION_X86\lld_interrupt_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\lld_mmu_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\lld_mmu_test.o -o %OUTPUT_DIR%\VERSION_X86\lld_mmu_test.exe  >> %OUTPUT_DIR%\VERSION_X86\lld_mmu_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\lld_power_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\lld_power_test.o -o %OUTPUT_DIR%\VERSION_X86\lld_power_test.exe  >> %OUTPUT_DIR%\VERSION_X86\lld_power_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\lld_ram_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\lld_ram_test.o -o %OUTPUT_DIR%\VERSION_X86\lld_ram_test.exe  >> %OUTPUT_DIR%\VERSION_X86\lld_ram_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\lld_timer_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\lld_timer_test.o -o %OUTPUT_DIR%\VERSION_X86\lld_timer_test.exe  >> %OUTPUT_DIR%\VERSION_X86\lld_timer_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\os_sim_main_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\os_sim_main_test.o -o %OUTPUT_DIR%\VERSION_X86\os_sim_main_test.exe  >> %OUTPUT_DIR%\VERSION_X86\os_sim_main_test.log 2>&1	
mingw32-g++.exe -march=i386 -g3 -static -Xlinker -Map=%OUTPUT_DIR%\VERSION_X86\led_test.map -O0  %OUTPUT_DIR%\os_base\obj_x86\led_test.o -o %OUTPUT_DIR%\VERSION_X86\led_test.exe  >> %OUTPUT_DIR%\VERSION_X86\led_test.log 2>&1	
@ENDLOCAL
pause
