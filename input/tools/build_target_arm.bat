...
arm-none-eabi-as                                             -c               %SRC_DIR%\os_base\os_exception_reset.s			-o %OUTPUT_DIR%\os_drivers\obj_arm\os_exception_reset.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
...
arm-none-eabi-as                                             -c               %SRC_DIR%\os_drivers\lld_power.s			-o %OUTPUT_DIR%\os_drivers\obj_arm\lld_power.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-as                                             -c               %SRC_DIR%\os_drivers\lld_ram.s			-o %OUTPUT_DIR%\os_drivers\obj_arm\lld_ram.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-as                                             -c               %SRC_DIR%\os_drivers\lld_timer.s			-o %OUTPUT_DIR%\os_drivers\obj_arm\lld_timer.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
