...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -E -mcpu=cortex-m4 -mthumb -g3 -O0 -std=gnu90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_exception.c			-o %OUTPUT_DIR%\os_base\ppc_arm\os_exception.ppc       >>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-adhls  -mcpu=cortex-m4 -mthumb -g3 -O0 -std=gnu90 -c %SRC_DIR%\os_base\os_exception.c			     >> %OUTPUT_DIR%\os_base\ppc_arm\os_exception.lst	            2>&1
...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O0 -std=gnu90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_exception.c 					-o %OUTPUT_DIR%\os_base\obj_arm\os_exception.o 		>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_exception_isr_handler.c		-o %OUTPUT_DIR%\os_base\obj_arm\os_exception_isr_handler.o		>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_exception_table.c	 		-o %OUTPUT_DIR%\os_base\obj_arm\os_exception_table.o 	>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_start_init_mc.c				-o %OUTPUT_DIR%\os_base\obj_arm\os_start_init_mc.o		>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_start_init_sw.c				-o %OUTPUT_DIR%\os_base\obj_arm\os_start_init_sw.o		>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_start_os.c					-o %OUTPUT_DIR%\os_base\obj_arm\os_start_os.o			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_task_common.c				-o %OUTPUT_DIR%\os_base\obj_arm\os_task_common.o		>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_task_queue.c					-o %OUTPUT_DIR%\os_base\obj_arm\os_task_queue.o		>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_task_scheduler.c				-o %OUTPUT_DIR%\os_base\obj_arm\os_task_scheduler.o	>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_ram.c					    -o %OUTPUT_DIR%\os_base\obj_arm\os_ram.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_shared_ram.c					    -o %OUTPUT_DIR%\os_base\obj_arm\os_shared_ram.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_user_code\led.c					-o %OUTPUT_DIR%\os_user_code\obj_arm\led.o			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1

REM
echo "assemble it" >> %OUTPUT_DIR%\VERSION_ARM\Build_ARM.log
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_common.c 					-o %OUTPUT_DIR%\os_base\obj_arm\os_common.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_exception.c 				-o %OUTPUT_DIR%\os_base\obj_arm\os_exception.s	>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_exception_isr_handler.c	-o %OUTPUT_DIR%\os_base\obj_arm\os_exception_isr_handler.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_exception_table.c	 		-o %OUTPUT_DIR%\os_base\obj_arm\os_exception_table.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_init_task_system.c	 	-o %OUTPUT_DIR%\os_base\obj_arm\os_init_task_system.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_main.c			 		-o %OUTPUT_DIR%\os_base\obj_arm\os_main.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_memory_mmu_setup.c	 	-o %OUTPUT_DIR%\os_base\obj_arm\os_memory_mmu_setup.s	>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_shutdown.c				-o %OUTPUT_DIR%\os_base\obj_arm\os_shutdown.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_start_ext_prg.c			-o %OUTPUT_DIR%\os_base\obj_arm\os_start_ext_prg.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_start_init_hw.c			-o %OUTPUT_DIR%\os_base\obj_arm\os_start_init_hw.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_start_init_mc.c			-o %OUTPUT_DIR%\os_base\obj_arm\os_start_init_mc.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_start_init_sw.c			-o %OUTPUT_DIR%\os_base\obj_arm\os_start_init_sw.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_start_os.c				-o %OUTPUT_DIR%\os_base\obj_arm\os_start_os.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_task_common.c				-o %OUTPUT_DIR%\os_base\obj_arm\os_task_common.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_task_queue.c				-o %OUTPUT_DIR%\os_base\obj_arm\os_task_queue.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-acdhlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_task_scheduler.c			-o %OUTPUT_DIR%\os_base\obj_arm\os_task_scheduler.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1

arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_ram.c          			-o %OUTPUT_DIR%\os_base\obj_arm\os_ram.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_shared_ram.c          			-o %OUTPUT_DIR%\os_base\obj_arm\os_shared_ram.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_const.c          			-o %OUTPUT_DIR%\os_base\obj_arm\os_const.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_stack.c          			-o %OUTPUT_DIR%\os_base\obj_arm\os_stack.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_heap.c          			-o %OUTPUT_DIR%\os_base\obj_arm\os_heap.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_user_code\led.c			-o %OUTPUT_DIR%\os_user_code\obj_arm\led.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
REM
