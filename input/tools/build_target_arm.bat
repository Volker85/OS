...
SET WRK_DIR="C:\Program Files (x86)\GNU Tools ARM Embedded\8 2019-q3-update\bin"
cd /D %WRK_DIR%
REM
set PATH=%PATH%;"C:\Program Files (x86)\GNU Tools ARM Embedded\8 2019-q3-update\bin"
...
SET LIB_DIR=C:\Program Files (x86)\GNU Tools ARM Embedded\8 2019-q3-update\lib
REM
...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -E -mcpu=cortex-m4 -mthumb -g3 -O3 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_memory_mmu.c		-o %OUTPUT_DIR%\os_base\ppc_arm\os_memory_mmu.ppc      >>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -E -mcpu=cortex-m4 -mthumb -g3 -O3 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_ram_shared.c		-o %OUTPUT_DIR%\os_base\ppc_arm\os_ram_shared.ppc                               >>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -E -mcpu=cortex-m4 -mthumb -g3 -O3 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_ram_stack.c		-o %OUTPUT_DIR%\os_base\ppc_arm\os_ram_stack.ppc                               >>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-adhls  -mcpu=cortex-m4 -mthumb -g3 -O3 -std=c90 -c %SRC_DIR%\os_base\os_memory_mmu.c		 >> %OUTPUT_DIR%\os_base\ppc_arm\os_memory_mmu.lst	    2>&1
...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-adhls  -mcpu=cortex-m4 -mthumb -g3 -O3 -std=c90 -c %SRC_DIR%\os_base\os_ram_shared.c		     >> %OUTPUT_DIR%\os_base\ppc_arm\os_ram_shared.lst                     2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-adhls  -mcpu=cortex-m4 -mthumb -g3 -O3 -std=c90 -c %SRC_DIR%\os_base\os_ram_stack.c		     >> %OUTPUT_DIR%\os_base\ppc_arm\os_ram_stack.lst                     2>&1
...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O3 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_memory_mmu.c	 		-o %OUTPUT_DIR%\os_base\obj_arm\os_memory_mmu.o 	>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O3 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_ram_shared.c					    -o %OUTPUT_DIR%\os_base\obj_arm\os_ram_shared.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O3 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_ram_stack.c					    -o %OUTPUT_DIR%\os_base\obj_arm\os_ram_stack.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O3 -fverbose-asm -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_memory_mmu.c	 	-o %OUTPUT_DIR%\os_base\obj_arm\os_memory_mmu.s	>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O3 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_ram_shared.c          			-o %OUTPUT_DIR%\os_base\obj_arm\os_ram_shared.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-achlns -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O3 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_ram_stack.c          			-o %OUTPUT_DIR%\os_base\obj_arm\os_ram_stack.s>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
