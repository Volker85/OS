...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -ggdb  -Wall -Wextra -Wpedantic -O0 -std=c90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_driver_hook.c 				-o %OUTPUT_DIR%\os_base\obj_arm\os_driver_hook.o		>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
...
arm-none-eabi-as                                             -c  -ggdb              %SRC_DIR%\os_base\os_exception_reset.s			-o %OUTPUT_DIR%\os_drivers\obj_arm\os_exception_reset.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-as                                             -c  -ggdb              %SRC_DIR%\os_drivers\lld_global.s			-o %OUTPUT_DIR%\os_drivers\obj_arm\lld_global.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-as                                             -c  -ggdb              %SRC_DIR%\os_drivers\lld_interrupt.s			-o %OUTPUT_DIR%\os_drivers\obj_arm\lld_interrupt.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-as                                             -c  -ggdb             %SRC_DIR%\os_drivers\lld_mmu.s			-o %OUTPUT_DIR%\os_drivers\obj_arm\lld_mmu.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-as                                             -c  -ggdb             %SRC_DIR%\os_drivers\lld_power.s			-o %OUTPUT_DIR%\os_drivers\obj_arm\lld_power.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-as                                             -c  -ggdb             %SRC_DIR%\os_drivers\lld_ram.s			-o %OUTPUT_DIR%\os_drivers\obj_arm\lld_ram.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-as                                             -c  -ggdb             %SRC_DIR%\os_drivers\lld_timer.s			-o %OUTPUT_DIR%\os_drivers\obj_arm\lld_timer.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -Wa,-adhln -S -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -std=gnu90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_driver_hook.c 			-o %OUTPUT_DIR%\os_base\obj_arm\os_driver_hook.s		>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
