...
arm-none-eabi-gcc -D CFG_PROCESSOR=4 -mcpu=cortex-m4 -mthumb -g3 -Wall -Wextra -Wpedantic -O0 -std=gnu90 -c -DSTM32F407VG %SRC_DIR%\os_base\os_exception.c 					-o %OUTPUT_DIR%\os_base\obj_arm\os_exception.o 		>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
...
arm-none-eabi-as                     -mcpu=cortex-m4 -mthumb                                           -c               %SRC_DIR%\os_base\os_exception_reset.s			-o %OUTPUT_DIR%\os_base\obj_arm\os_exception_reset.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-as                     -mcpu=cortex-m4 -mthumb                                           -c               %SRC_DIR%\os_drivers\lld_global.s			-o %OUTPUT_DIR%\os_drivers\obj_arm\lld_global.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-as                     -mcpu=cortex-m4 -mthumb                                           -c               %SRC_DIR%\os_drivers\lld_interrupt.s			-o %OUTPUT_DIR%\os_drivers\obj_arm\lld_interrupt.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
arm-none-eabi-as                     -mcpu=cortex-m4 -mthumb                                           -c               %SRC_DIR%\os_drivers\lld_mmu.s			-o %OUTPUT_DIR%\os_drivers\obj_arm\lld_mmu.o   			>>%OUTPUT_DIR%\VERSION_ARM\Build_ARM.log 2>&1
